...
- 后续仍需 DeepAgents 虚拟文件夹真实迁移、transaction state machine、GitHub Release provider，以及更高级 Browser/CDP 调试能力；Android / iOS / 小程序完整运行链路继续搁置。
