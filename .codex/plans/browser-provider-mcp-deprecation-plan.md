...
- Boundary：这是 explicit retry baseline，不自动放大外部发布副作用；更复杂的 per-provider rate-limit policy、jitter、retry budget、idempotency ledger 绑定和 GitHub asset overwrite / delete 仍是后续工作。
