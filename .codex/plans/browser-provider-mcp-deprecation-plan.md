...
- 后续仍需独立 BrowserProvider plugin package template / cookiecutter、provider capability compatibility matrix 更细粒度校验，以及 `browser_runtime` 子智能体实体化。Android / iOS / 小程序完整运行链路继续搁置。
