...
| 8. CDP-enhanced collectors | 进行中 | baseline request initiator / response body metadata / unsupported script-source 和 WebSocket frame 输出已完成；Debugger.scriptParsed 和 WebSocket 事件缓存待后续 |
