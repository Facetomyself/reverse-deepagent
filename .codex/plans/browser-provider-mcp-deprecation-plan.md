...
- 后续仍需 rollback apply executor / physical state machine、stronger distributed transaction locking / resume semantics、advanced adaptive provider retry policy 和第三方 external delivery provider；Android / iOS / 小程序完整运行链路继续搁置。
