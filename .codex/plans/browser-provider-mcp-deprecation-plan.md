...
- 后续仍需显式审批的 backend manifest in-place mutation executor、cross-run recovery state machine、transaction idempotency 和外部交付执行器。
