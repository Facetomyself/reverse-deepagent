...
- 已扩展算法策略识别：`md5`、`sha1`、`sha256`、`sha512`、`hmac-md5`、`hmac-sha1`、`hmac-sha256`、`hmac-sha512`、`base64`、`urlencode`
...
- `hybrid-context` profile 能覆盖 cookie + localStorage 多上下文绑定，并在上下文都已采集时生成 context-aware delivery
