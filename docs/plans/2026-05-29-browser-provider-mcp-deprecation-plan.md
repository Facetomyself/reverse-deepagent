...
- `auto_stitch_dry_runs` dry-run scoring records with conflict summaries and fixed `would_materialize=false` / `automatic_stitching=false` safeguards
