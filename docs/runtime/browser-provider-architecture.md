...
- External source-map URL / indexed-section URL fetching, bundler-specific symbol scoping, and full source-map consumer semantics beyond the local payload remap baseline.
