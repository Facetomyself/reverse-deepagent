...
- Review-gated follow-through on `review_workspace_dual_write_pilot_workflow` evidence before any broader dual-write rollout or foldered-canonical migration pilot; default pilots stay low-risk, result recording remains explicit, and migration remains blocked while partial consumers or source_path evidence require compatibility monitoring.
