...
- Full source-map consumer semantics, credentialed browser Source Map fetching, and automatic logpoint remap follow-through beyond the local remap, review-only bundler symbol scope descriptor, and review-gated credentialless Source Map URL fetch metadata baseline.
