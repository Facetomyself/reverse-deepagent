...
- `workspace/async-chunk-load-plan.json`, `workspace/async-chunk-load-result.json`, and `workspace/async-chunk-module-diff.json` when explicit `async-chunk-load` planning / reviewed execution / post-load diff refresh is requested.
- `workspace/debugger-paused.json`
- `workspace/callframes.json`
