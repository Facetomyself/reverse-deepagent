...
- Execution-style arbitrary custom loader traversal, actual async chunk loading / traversal, and module federation `get/init` analysis beyond the current read-only runtime-path and chunk-graph baselines.
