...
class DoctorTests(unittest.TestCase):
    ...
    def test_doctor_can_emit_side_effect_free_browser_provider_matrix(self) -> None:
        ...
        self.assertEqual(matrix["production_readiness_version"], "2026-06-01.production-readiness-v2")
        ...
        self.assertGreaterEqual(len(matrix["production_readiness_rules"]), 1)
