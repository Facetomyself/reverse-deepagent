...
def build_reverse_agent(
    ...
    *,
    ...
    tools = [
        ...
        make_plan_workspace_foldered_canonical_migration_pilot_tool(effective_artifact_root),
        make_review_workspace_foldered_canonical_migration_preflight_tool(effective_artifact_root),
        make_plan_workspace_foldered_canonical_migration_apply_tool(effective_artifact_root),
        make_plan_workspace_foldered_canonical_migration_approval_tool(effective_artifact_root),
        make_review_workspace_foldered_canonical_migration_manifest_dry_run_tool(effective_artifact_root),
        make_review_workspace_foldered_canonical_migration_physical_apply_preflight_tool(effective_artifact_root),
        make_execute_workspace_foldered_canonical_physical_apply_tool(effective_artifact_root),
        make_review_workspace_foldered_canonical_migration_post_apply_validation_tool(effective_artifact_root),
        make_record_workspace_foldered_canonical_migration_post_apply_validation_result_tool(effective_artifact_root),
        make_review_workspace_foldered_canonical_legacy_fallback_tightening_readiness_tool(effective_artifact_root),
        make_plan_workspace_foldered_canonical_legacy_fallback_tightening_tool(effective_artifact_root),
        make_review_workspace_foldered_canonical_legacy_fallback_tightening_preflight_tool(effective_artifact_root),
        make_execute_workspace_foldered_canonical_legacy_fallback_tightening_tool(effective_artifact_root),
        make_review_workspace_foldered_canonical_migration_finalization_readiness_tool(effective_artifact_root),
        make_plan_workspace_foldered_canonical_migration_finalization_tool(effective_artifact_root),
        make_review_workspace_foldered_canonical_migration_finalization_preflight_tool(effective_artifact_root),
        make_execute_workspace_foldered_canonical_migration_finalization_tool(effective_artifact_root),
        make_review_workspace_foldered_canonical_migration_post_finalization_audit_tool(effective_artifact_root),
        ...
        make_review_workspace_foldered_canonical_broader_rollout_post_audit_tool(effective_artifact_root),
        make_plan_workspace_foldered_canonical_broader_rollout_rollback_decision_tool(effective_artifact_root),
        make_record_workspace_foldered_canonical_broader_rollout_decision_tool(effective_artifact_root),
        make_execute_workspace_foldered_canonical_broader_rollout_commit_tool(effective_artifact_root),
        make_review_workspace_foldered_canonical_broader_rollout_rollback_preflight_tool(effective_artifact_root),
        make_execute_workspace_foldered_canonical_broader_rollout_rollback_tool(effective_artifact_root),
