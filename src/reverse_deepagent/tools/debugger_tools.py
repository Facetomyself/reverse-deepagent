...
AUTOMATIC_LOOP_MULTI_ITERATION_EXECUTOR_APPROVAL_RECORD_VERSION = "reverse-deepagent.paused-session-automatic-loop-multi-iteration-executor-approval-record.v1"
...
def make_review_debugger_artifacts_tool(default_artifact_root: str | Path | None = None):
    ...
    def review_debugger_artifacts(
        ...
        automatic_loop_multi_iteration_policy = _object_alias(
            payload,
        ...
        automatic_loop_multi_iteration_executor_preflight = _object_alias(
            payload,
        ...
        automatic_loop_multi_iteration_execution_plan = _object_alias(
            payload,
        ...
        automatic_loop_multi_iteration_executor_approval_plan = _object_alias(
            payload,
        ...
        automatic_loop_multi_iteration_followup_checkpoint = _object_alias(
            payload,
        ...
        automatic_loop_multi_iteration_next_step_plan = _object_alias(
            payload,
        ...
        automatic_loop_multi_iteration_executor_input_preflight = _object_alias(
            payload,
            ...
            "automatic_loop_multi_iteration_executor_input_preflight",
            "automaticLoopMultiIterationExecutorInputPreflight",
        )
        ...
        automatic_loop_multi_iteration = _first_object(automatic_loop_multi_iteration_policy.get("policy"), automatic_loop_multi_iteration_policy)
        ...
        automatic_loop_multi_iteration_followup = _first_object(automatic_loop_multi_iteration_followup_checkpoint.get("checkpoint"), automatic_loop_multi_iteration_followup_checkpoint)
        automatic_loop_multi_iteration_next_step = _first_object(automatic_loop_multi_iteration_next_step_plan.get("plan"), automatic_loop_multi_iteration_next_step_plan)
        automatic_loop_multi_iteration_executor_input = _first_object(automatic_loop_multi_iteration_executor_input_preflight.get("preflight"), automatic_loop_multi_iteration_executor_input_preflight)
        ...
        automatic_loop_multi_iteration_status = _string(automatic_loop_multi_iteration.get("status"))
        if automatic_loop_multi_iteration_status == "blocked":
            blockers.append("paused_session_automatic_loop_multi_iteration_policy_blocked")
        if automatic_loop_multi_iteration_status == "ready_for_review":
            warnings.append("automatic_loop_multi_iteration_policy_requires_executor_review")
        automatic_loop_multi_iteration_preflight_status = _string(automatic_loop_multi_iteration_preflight.get("status"))
        if automatic_loop_multi_iteration_preflight_status == "blocked":
            blockers.append("paused_session_automatic_loop_multi_iteration_executor_preflight_blocked")
        if automatic_loop_multi_iteration_preflight_status == "ready_for_review":
            warnings.append("automatic_loop_multi_iteration_executor_preflight_requires_review")
        automatic_loop_multi_iteration_plan_status = _string(automatic_loop_multi_iteration_plan.get("status"))
        if automatic_loop_multi_iteration_plan_status == "blocked":
            blockers.append("paused_session_automatic_loop_multi_iteration_execution_plan_blocked")
        if automatic_loop_multi_iteration_plan_status == "ready_for_review":
            warnings.append("automatic_loop_multi_iteration_execution_plan_requires_review")
        automatic_loop_multi_iteration_approval_status = _string(automatic_loop_multi_iteration_approval.get("status"))
        if automatic_loop_multi_iteration_approval_status == "blocked":
        ...
        automatic_loop_multi_iteration_followup_status = _string(automatic_loop_multi_iteration_followup.get("status"))
        if automatic_loop_multi_iteration_followup_status == "blocked":
            blockers.append("paused_session_automatic_loop_multi_iteration_followup_checkpoint_blocked")
        if automatic_loop_multi_iteration_followup_status == "ready_for_review" and not automatic_loop_multi_iteration_next_step:
            next_loop_review = automatic_loop_multi_iteration_followup.get("next_loop_review") if isinstance(automatic_loop_multi_iteration_followup.get("next_loop_review"), dict) else {}
            if _boolish(next_loop_review.get("next_loop_plan_ready")):
                warnings.append("automatic_loop_multi_iteration_followup_checkpoint_ready_for_next_loop_review")
            else:
                warnings.append("automatic_loop_multi_iteration_followup_checkpoint_requires_next_loop_plan")
        automatic_loop_multi_iteration_next_step_status = _string(automatic_loop_multi_iteration_next_step.get("status"))
        if automatic_loop_multi_iteration_next_step_status == "blocked":
            blockers.append("paused_session_automatic_loop_multi_iteration_next_step_plan_blocked")
        if automatic_loop_multi_iteration_next_step_status == "ready_for_review":
            warnings.append("automatic_loop_multi_iteration_next_step_plan_requires_execution_review")
        automatic_loop_multi_iteration_executor_input_status = _string(automatic_loop_multi_iteration_executor_input.get("status"))
        if automatic_loop_multi_iteration_executor_input_status == "blocked":
            blockers.append("paused_session_automatic_loop_multi_iteration_executor_input_preflight_blocked")
        if automatic_loop_multi_iteration_executor_input_status == "ready_for_review":
            warnings.append("automatic_loop_multi_iteration_executor_input_preflight_requires_execution_review")
        ...
        return {
            ...
            "summary": {
                ...
                "automatic_loop_multi_iteration_policy": {
                    "status": _string(automatic_loop_multi_iteration.get("status") or "unknown"),
                    "ready_for_review": _boolish(automatic_loop_multi_iteration.get("ready_for_review")),
                    "policy_id": _string(automatic_loop_multi_iteration.get("policy_id")),
                    "max_policy_iterations": _nested_get(automatic_loop_multi_iteration, "budget_policy", "max_policy_iterations"),
                    "automatic_multi_iteration_executor_implemented": _boolish(_nested_get(automatic_loop_multi_iteration, "budget_policy", "automatic_multi_iteration_executor_implemented")),
                    "automatic_multi_iteration_execution_allowed_now": _boolish(_nested_get(automatic_loop_multi_iteration, "budget_policy", "automatic_multi_iteration_execution_allowed_now")),
                    "requires_review_per_iteration": _boolish(_nested_get(automatic_loop_multi_iteration, "budget_policy", "requires_review_per_iteration")),
                    "requires_checkpoint_after_each_iteration": _boolish(_nested_get(automatic_loop_multi_iteration, "budget_policy", "requires_checkpoint_after_each_iteration")),
                    "requires_fresh_live_callframe_per_iteration": _boolish(_nested_get(automatic_loop_multi_iteration, "budget_policy", "requires_fresh_live_callframe_per_iteration")),
                    "stop_after_each_checkpoint": _boolish(_nested_get(automatic_loop_multi_iteration, "budget_policy", "stop_after_each_checkpoint")),
                    "automatic_multi_iteration_loop": _boolish(_nested_get(automatic_loop_multi_iteration, "side_effect_policy", "automatic_multi_iteration_loop")),
                    "loop_advanced": _boolish(_nested_get(automatic_loop_multi_iteration, "side_effect_policy", "loop_advanced")),
                    "queue_advanced": _boolish(_nested_get(automatic_loop_multi_iteration, "side_effect_policy", "queue_advanced")),
                    "calls_mcp": _boolish(_nested_get(automatic_loop_multi_iteration, "side_effect_policy", "calls_mcp")),
                    "mobile_runtime_used": _boolish(_nested_get(automatic_loop_multi_iteration, "side_effect_policy", "mobile_runtime_used")),
                    "blockers": automatic_loop_multi_iteration.get("blockers") if isinstance(automatic_loop_multi_iteration.get("blockers"), list) else [],
                },
                "automatic_loop_multi_iteration_executor_preflight": {
                    "status": _string(automatic_loop_multi_iteration_preflight.get("status") or "unknown"),
                    "ready_for_review": _boolish(automatic_loop_multi_iteration_preflight.get("ready_for_review")),
                    "preflight_id": _string(automatic_loop_multi_iteration_preflight.get("preflight_id")),
                    "policy_id": _string(automatic_loop_multi_iteration_preflight.get("policy_id")),
                    "preflight_iteration_count": automatic_loop_multi_iteration_preflight.get("preflight_iteration_count", 0),
                    "policy_iteration_budget": automatic_loop_multi_iteration_preflight.get("policy_iteration_budget", 0),
                    "ready_to_execute_now": _boolish(_nested_get(automatic_loop_multi_iteration_preflight, "executor_input_gates", "ready_to_execute_now")),
                    "automatic_multi_iteration_executor_implemented": _boolish(_nested_get(automatic_loop_multi_iteration_preflight, "executor_input_gates", "automatic_multi_iteration_executor_implemented")),
                    "automatic_multi_iteration_execution_allowed_now": _boolish(_nested_get(automatic_loop_multi_iteration_preflight, "executor_input_gates", "automatic_multi_iteration_execution_allowed_now")),
                    "future_executor_implemented": _boolish(_nested_get(automatic_loop_multi_iteration_preflight, "future_executor_contract", "implemented")),
                    "automatic_multi_iteration_loop": _boolish(_nested_get(automatic_loop_multi_iteration_preflight, "side_effect_policy", "automatic_multi_iteration_loop")),
                    "loop_advanced": _boolish(_nested_get(automatic_loop_multi_iteration_preflight, "side_effect_policy", "loop_advanced")),
                    "queue_advanced": _boolish(_nested_get(automatic_loop_multi_iteration_preflight, "side_effect_policy", "queue_advanced")),
                    "calls_mcp": _boolish(_nested_get(automatic_loop_multi_iteration_preflight, "side_effect_policy", "calls_mcp")),
                    "mobile_runtime_used": _boolish(_nested_get(automatic_loop_multi_iteration_preflight, "side_effect_policy", "mobile_runtime_used")),
                    "blockers": automatic_loop_multi_iteration_preflight.get("blockers") if isinstance(automatic_loop_multi_iteration_preflight.get("blockers"), list) else [],
                },
                "automatic_loop_multi_iteration_execution_plan": {
                    "status": _string(automatic_loop_multi_iteration_plan.get("status") or "unknown"),
                    "ready_for_review": _boolish(automatic_loop_multi_iteration_plan.get("ready_for_review")),
                    "execution_plan_id": _string(automatic_loop_multi_iteration_plan.get("execution_plan_id")),
                    "preflight_id": _string(automatic_loop_multi_iteration_plan.get("preflight_id")),
                    "policy_id": _string(automatic_loop_multi_iteration_plan.get("policy_id")),
                    "planned_iteration_count": automatic_loop_multi_iteration_plan.get("planned_iteration_count", 0),
                    "max_planned_iterations": automatic_loop_multi_iteration_plan.get("max_planned_iterations", 0),
                    "ready_to_execute_now": _boolish(_nested_get(automatic_loop_multi_iteration_plan, "execution_review_gates", "ready_to_execute_now")),
                    "automatic_multi_iteration_executor_implemented": _boolish(_nested_get(automatic_loop_multi_iteration_plan, "execution_review_gates", "automatic_multi_iteration_executor_implemented")),
                    "automatic_multi_iteration_execution_allowed_now": _boolish(_nested_get(automatic_loop_multi_iteration_plan, "execution_review_gates", "automatic_multi_iteration_execution_allowed_now")),
                    "future_executor_implemented": _boolish(_nested_get(automatic_loop_multi_iteration_plan, "future_executor_contract", "implemented")),
                    "automatic_multi_iteration_loop": _boolish(_nested_get(automatic_loop_multi_iteration_plan, "side_effect_policy", "automatic_multi_iteration_loop")),
                    "loop_advanced": _boolish(_nested_get(automatic_loop_multi_iteration_plan, "side_effect_policy", "loop_advanced")),
                    "queue_advanced": _boolish(_nested_get(automatic_loop_multi_iteration_plan, "side_effect_policy", "queue_advanced")),
                    "calls_mcp": _boolish(_nested_get(automatic_loop_multi_iteration_plan, "side_effect_policy", "calls_mcp")),
                    "mobile_runtime_used": _boolish(_nested_get(automatic_loop_multi_iteration_plan, "side_effect_policy", "mobile_runtime_used")),
                    "blockers": automatic_loop_multi_iteration_plan.get("blockers") if isinstance(automatic_loop_multi_iteration_plan.get("blockers"), list) else [],
                },
                "automatic_loop_multi_iteration_executor_approval_plan": {
                    "status": _string(automatic_loop_multi_iteration_approval.get("status") or "unknown"),
                    "ready_for_review": _boolish(automatic_loop_multi_iteration_approval.get("ready_for_review")),
                    "approval_plan_id": _string(automatic_loop_multi_iteration_approval.get("approval_plan_id")),
                    "execution_plan_id": _string(automatic_loop_multi_iteration_approval.get("execution_plan_id")),
                    "preflight_id": _string(automatic_loop_multi_iteration_approval.get("preflight_id")),
                    "policy_id": _string(automatic_loop_multi_iteration_approval.get("policy_id")),
                    "approved_iteration_count": automatic_loop_multi_iteration_approval.get("approved_iteration_count", 0),
                    "ready_to_execute_now": _boolish(_nested_get(automatic_loop_multi_iteration_approval, "executor_input_gates", "ready_to_execute_now")),
                    "automatic_multi_iteration_executor_implemented": _boolish(_nested_get(automatic_loop_multi_iteration_approval, "executor_input_gates", "automatic_multi_iteration_executor_implemented")),
                    "automatic_multi_iteration_execution_allowed_now": _boolish(_nested_get(automatic_loop_multi_iteration_approval, "executor_input_gates", "automatic_multi_iteration_execution_allowed_now")),
                    "future_executor_implemented": _boolish(_nested_get(automatic_loop_multi_iteration_approval, "future_executor_contract", "implemented")),
                    "approval_recorded": _boolish(_nested_get(automatic_loop_multi_iteration_approval, "executor_input_gates", "approval_recorded")),
                    "transaction_started": _boolish(_nested_get(automatic_loop_multi_iteration_approval, "transaction_plan", "transaction_started")),
                    "journal_written": _boolish(_nested_get(automatic_loop_multi_iteration_approval, "transaction_plan", "journal_written_now")),
                    "automatic_multi_iteration_loop": _boolish(_nested_get(automatic_loop_multi_iteration_approval, "side_effect_policy", "automatic_multi_iteration_loop")),
                    "loop_advanced": _boolish(_nested_get(automatic_loop_multi_iteration_approval, "side_effect_policy", "loop_advanced")),
                    "queue_advanced": _boolish(_nested_get(automatic_loop_multi_iteration_approval, "side_effect_policy", "queue_advanced")),
                    "calls_mcp": _boolish(_nested_get(automatic_loop_multi_iteration_approval, "side_effect_policy", "calls_mcp")),
                ...
                "automatic_loop_multi_iteration_followup_checkpoint": {
                    "status": _string(automatic_loop_multi_iteration_followup.get("status") or "unknown"),
                    "ready_for_review": _boolish(automatic_loop_multi_iteration_followup.get("ready_for_review")),
                    "transaction_id": _string(automatic_loop_multi_iteration_followup.get("transaction_id")),
                    "checkpoint_ready": _boolish(_nested_get(automatic_loop_multi_iteration_followup, "checkpoint_review", "checkpoint_ready")),
                    "next_loop_plan_ready": _boolish(_nested_get(automatic_loop_multi_iteration_followup, "next_loop_review", "next_loop_plan_ready")),
                    "next_iteration_reviewable": _boolish(_nested_get(automatic_loop_multi_iteration_followup, "next_loop_review", "next_iteration_reviewable")),
                    "checkpoint_written": _boolish(_nested_get(automatic_loop_multi_iteration_followup, "side_effect_policy", "checkpoint_written")),
                    "automatic_multi_iteration_loop": _boolish(_nested_get(automatic_loop_multi_iteration_followup, "side_effect_policy", "automatic_multi_iteration_loop")),
                    "loop_advanced": _boolish(_nested_get(automatic_loop_multi_iteration_followup, "side_effect_policy", "loop_advanced")),
                    "queue_advanced": _boolish(_nested_get(automatic_loop_multi_iteration_followup, "side_effect_policy", "queue_advanced")),
                    "calls_mcp": _boolish(_nested_get(automatic_loop_multi_iteration_followup, "side_effect_policy", "calls_mcp")),
                    "mobile_runtime_used": _boolish(_nested_get(automatic_loop_multi_iteration_followup, "side_effect_policy", "mobile_runtime_used")),
                    "blockers": automatic_loop_multi_iteration_followup.get("blockers") if isinstance(automatic_loop_multi_iteration_followup.get("blockers"), list) else [],
                },
                "automatic_loop_multi_iteration_next_step_plan": {
                    "status": _string(automatic_loop_multi_iteration_next_step.get("status") or "unknown"),
                    "ready_for_review": _boolish(automatic_loop_multi_iteration_next_step.get("ready_for_review")),
                    "transaction_id": _string(automatic_loop_multi_iteration_next_step.get("transaction_id")),
                    "multi_iteration_followup_checkpoint_ready": _boolish(_nested_get(automatic_loop_multi_iteration_next_step, "checkpoint_review", "multi_iteration_followup_checkpoint_ready")),
                    "continuation_checkpoint_ready": _boolish(_nested_get(automatic_loop_multi_iteration_next_step, "checkpoint_review", "continuation_checkpoint_ready")),
                    "next_loop_plan_ready": _boolish(_nested_get(automatic_loop_multi_iteration_next_step, "next_iteration", "next_loop_plan_ready")),
                    "next_iteration_reviewable": _boolish(_nested_get(automatic_loop_multi_iteration_next_step, "next_iteration", "next_iteration_reviewable")),
                    "fresh_live_callframe_recovered": _boolish(_nested_get(automatic_loop_multi_iteration_next_step, "next_iteration", "fresh_live_callframe_recovered")),
                    "expected_executor": _string(_nested_get(automatic_loop_multi_iteration_next_step, "expected_executor", "name")),
                    "step264_executor_mvp": _boolish(_nested_get(automatic_loop_multi_iteration_next_step, "expected_executor", "step264_executor_mvp")),
                    "would_execute_multi_iteration": _boolish(_nested_get(automatic_loop_multi_iteration_next_step, "side_effect_policy", "would_execute_multi_iteration")),
                    "automatic_multi_iteration_loop": _boolish(_nested_get(automatic_loop_multi_iteration_next_step, "side_effect_policy", "automatic_multi_iteration_loop")),
                    "loop_advanced": _boolish(_nested_get(automatic_loop_multi_iteration_next_step, "side_effect_policy", "loop_advanced")),
                    "queue_advanced": _boolish(_nested_get(automatic_loop_multi_iteration_next_step, "side_effect_policy", "queue_advanced")),
                    "calls_mcp": _boolish(_nested_get(automatic_loop_multi_iteration_next_step, "side_effect_policy", "calls_mcp")),
                    "mobile_runtime_used": _boolish(_nested_get(automatic_loop_multi_iteration_next_step, "side_effect_policy", "mobile_runtime_used")),
                    "blockers": automatic_loop_multi_iteration_next_step.get("blockers") if isinstance(automatic_loop_multi_iteration_next_step.get("blockers"), list) else [],
                },
                "automatic_loop_multi_iteration_executor_input_preflight": {
                    "status": _string(automatic_loop_multi_iteration_executor_input.get("status") or "unknown"),
                    "ready_for_review": _boolish(automatic_loop_multi_iteration_executor_input.get("ready_for_review")),
                    "ready_for_execution_review": _boolish(automatic_loop_multi_iteration_executor_input.get("ready_for_execution_review")),
                    "ready_to_execute_now": _boolish(automatic_loop_multi_iteration_executor_input.get("ready_to_execute_now")),
                    "preflight_id": _string(automatic_loop_multi_iteration_executor_input.get("preflight_id")),
                    "transaction_id": _string(automatic_loop_multi_iteration_executor_input.get("transaction_id")),
                    "journal_id": _string(automatic_loop_multi_iteration_executor_input.get("journal_id")),
                    "next_step_plan_ready": _boolish(_nested_get(automatic_loop_multi_iteration_executor_input, "executor_input_checks", "next_step_plan_ready")),
                    "bounded_executor_gate_ready": _boolish(_nested_get(automatic_loop_multi_iteration_executor_input, "executor_input_checks", "bounded_executor_gate_ready")),
                    "transaction_journal_written": _boolish(_nested_get(automatic_loop_multi_iteration_executor_input, "executor_input_checks", "transaction_journal_written")),
                    "loop_plan_ready": _boolish(_nested_get(automatic_loop_multi_iteration_executor_input, "executor_input_checks", "loop_plan_ready")),
                    "workflow_ready": _boolish(_nested_get(automatic_loop_multi_iteration_executor_input, "executor_input_checks", "workflow_ready")),
                    "fresh_live_callframe_recovered": _boolish(_nested_get(automatic_loop_multi_iteration_executor_input, "executor_input_checks", "fresh_live_callframe_recovered")),
                    "retained_attached_session_available": _boolish(_nested_get(automatic_loop_multi_iteration_executor_input, "executor_input_checks", "retained_attached_session_available")),
                    "selected_iteration_ready_for_executor_review": _boolish(_nested_get(automatic_loop_multi_iteration_executor_input, "executor_input_checks", "selected_iteration_ready_for_executor_review")),
                    "expected_executor": _string(_nested_get(automatic_loop_multi_iteration_executor_input, "expected_executor", "name")),
                    "step264_executor_mvp": _boolish(_nested_get(automatic_loop_multi_iteration_executor_input, "expected_executor", "step264_executor_mvp")),
                    "would_execute_multi_iteration": _boolish(_nested_get(automatic_loop_multi_iteration_executor_input, "side_effect_policy", "would_execute_multi_iteration")),
                    "automatic_multi_iteration_loop": _boolish(_nested_get(automatic_loop_multi_iteration_executor_input, "side_effect_policy", "automatic_multi_iteration_loop")),
                    "loop_advanced": _boolish(_nested_get(automatic_loop_multi_iteration_executor_input, "side_effect_policy", "loop_advanced")),
                    "queue_advanced": _boolish(_nested_get(automatic_loop_multi_iteration_executor_input, "side_effect_policy", "queue_advanced")),
                    "calls_mcp": _boolish(_nested_get(automatic_loop_multi_iteration_executor_input, "side_effect_policy", "calls_mcp")),
                    "mobile_runtime_used": _boolish(_nested_get(automatic_loop_multi_iteration_executor_input, "side_effect_policy", "mobile_runtime_used")),
                    "blockers": automatic_loop_multi_iteration_executor_input.get("blockers") if isinstance(automatic_loop_multi_iteration_executor_input.get("blockers"), list) else [],
                },
            },
            "blockers": blockers,
            "warnings": warnings,
            "review_required_items": _review_required_items(blockers, warnings, preflight, readiness, execution_plan, session_lifecycle, attach_probe, callframe_recovery_artifact, one_action_execution, pre_action_orchestration, next_capture_execution, continuation_checkpoint, multi_step_workflow, multi_step_execution, multi_step_loop, multi_step_loop_exec, automatic_loop_result, automatic_loop_followup, automatic_loop_next_iteration, automatic_loop_next_iteration_result, automatic_loop_next_iteration_followup, automatic_loop_following_iteration, automatic_loop_multi_iteration, automatic_loop_multi_iteration_preflight, automatic_loop_multi_iteration_plan, automatic_loop_multi_iteration_approval, automatic_loop_multi_iteration_result, automatic_loop_multi_iteration_followup, automatic_loop_multi_iteration_next_step, automatic_loop_multi_iteration_executor_input, session, paused),
            "side_effect_policy": {
                "read_only": True,
                "files_mutated": False,
...
def make_record_paused_session_automatic_loop_multi_iteration_executor_approval_tool(default_artifact_root: str | Path | None = None):
    """Create an explicit approval-record writer for future multi-iteration automatic-loop execution.

    The tool only records reviewer approval metadata for a ready multi-iteration
    approval-plan descriptor. It never starts transactions, writes executor
    journals, executes loop iterations, sends CDP commands, recovers callFrames,
    advances queues, calls MCP, or touches mobile runtime chains.
    """

    root = Path(default_artifact_root) if default_artifact_root is not None else Path("artifacts")

    def record_paused_session_automatic_loop_multi_iteration_executor_approval(
        approval_plan_json: str | None = None,
        approval_plan_ref: str | None = None,
        reviewer: str | None = None,
        decision: str = "approved",
        ...
        """Record reviewer approval for a ready multi-iteration automatic-loop approval plan."""

        metadata = _loads_optional_object(metadata_json, field_name="metadata_json")
        return record_paused_session_automatic_loop_multi_iteration_executor_approval_payload(
            approval_plan_json=approval_plan_json,
            approval_plan_ref=approval_plan_ref,
            reviewer=reviewer,
            decision=decision,
    ...
    record_paused_session_automatic_loop_multi_iteration_executor_approval.__name__ = "record_paused_session_automatic_loop_multi_iteration_executor_approval"
    return record_paused_session_automatic_loop_multi_iteration_executor_approval
...
def make_review_paused_session_automatic_loop_multi_iteration_transaction_preflight_tool(default_artifact_root: str | Path | None = None):
    """Create a read-only transaction / journal preflight reviewer for multi-iteration automatic loops.

    This tool verifies that a ready multi-iteration approval-plan descriptor and
    an explicit multi-iteration approval-record artifact can be used as input
    for a future transaction journal writer. It never writes journals, starts
    transactions, sends CDP commands, executes iterations, calls MCP, or touches
    mobile runtime chains.
    """

    root = Path(default_artifact_root) if default_artifact_root is not None else Path("artifacts")

    def review_paused_session_automatic_loop_multi_iteration_transaction_preflight(
        approval_plan_json: str | None = None,
        approval_plan_ref: str | None = None,
        approval_record_json: str | None = None,
        approval_record_ref: str | None = None,
        ...
        """Review multi-iteration automatic-loop transaction / journal writer readiness."""

        metadata = _loads_optional_object(metadata_json, field_name="metadata_json")
        return review_paused_session_automatic_loop_multi_iteration_transaction_preflight_payload(
            approval_plan_json=approval_plan_json,
            approval_plan_ref=approval_plan_ref,
            approval_record_json=approval_record_json,
            approval_record_ref=approval_record_ref,
    ...
    review_paused_session_automatic_loop_multi_iteration_transaction_preflight.__name__ = "review_paused_session_automatic_loop_multi_iteration_transaction_preflight"
    return review_paused_session_automatic_loop_multi_iteration_transaction_preflight


def make_record_paused_session_automatic_loop_multi_iteration_transaction_journal_tool(default_artifact_root: str | Path | None = None):
    """Create an explicit transaction journal writer for multi-iteration automatic loops.

    The writer consumes a ready multi-iteration transaction preflight and writes
    only an append-only audit artifact after explicit review. It never sends CDP
    commands, recovers callFrames, executes iterations, advances queues, calls
    MCP, or touches mobile runtime chains.
    """

    root = Path(default_artifact_root) if default_artifact_root is not None else Path("artifacts")

    def record_paused_session_automatic_loop_multi_iteration_transaction_journal(
        ...
        """Write a reviewed multi-iteration automatic-loop transaction journal record."""

        metadata = _loads_optional_object(metadata_json, field_name="metadata_json")
        return record_paused_session_automatic_loop_multi_iteration_transaction_journal_payload(
    ...
    record_paused_session_automatic_loop_multi_iteration_transaction_journal.__name__ = "record_paused_session_automatic_loop_multi_iteration_transaction_journal"
...
def record_paused_session_automatic_loop_multi_iteration_executor_approval_payload(
    *,
    approval_plan_json: str | None = None,
    approval_plan_ref: str | None = None,
    reviewer: str | None = None,
    ...
    """Build or write the multi-iteration automatic-loop executor approval record payload."""
    ...
    effective_root = effective_root.expanduser().resolve()
    plan_digest = _stable_json_digest(approval_plan) if approval_plan else None
    blockers = _automatic_loop_multi_iteration_executor_approval_record_blockers(
        approval_plan=approval_plan,
        reviewer=reviewer,
        decision=decision,
        mode=mode,
    ...
    created_at = datetime.now(timezone.utc).isoformat()
    approval_plan_id = _string(approval_plan.get("approval_plan_id"))
    execution_plan_id = _string(approval_plan.get("execution_plan_id"))
    preflight_id = _string(approval_plan.get("preflight_id"))
    policy_id = _string(approval_plan.get("policy_id"))
    approval_record_id = _automatic_loop_multi_iteration_executor_approval_record_id(
        approval_plan_id=approval_plan_id,
    ...
    result_path = effective_root / "workspace" / "paused-session-automatic-loop-multi-iteration-executor-approval-record.json"
    approved_iterations = [item for item in approval_plan.get("approved_iterations", []) if isinstance(item, dict)]
    payload: dict[str, Any] = {
        "schema_version": AUTOMATIC_LOOP_MULTI_ITERATION_EXECUTOR_APPROVAL_RECORD_VERSION,
        "status": status,
        "approval_recorded": written,
        "approved_for_execution": approved_for_execution,
        "dry_run": not written,
        ...
        "approval_record_id": approval_record_id,
        "approval_plan_id": approval_plan_id or None,
        "execution_plan_id": execution_plan_id or None,
        "preflight_id": preflight_id or None,
        "policy_id": policy_id or None,
        "transaction_id": _nested_get(approval_plan, "transaction_plan", "transaction_id"),
        "decision": decision,
        "reviewer": reviewer,
        "reason": reason,
        "created_at": created_at,
        ...
        "source_approval_plan_summary": {
            ...
            "max_approved_iterations": approval_plan.get("max_approved_iterations", 0),
            "ready_to_execute_now": _boolish(_nested_get(approval_plan, "executor_input_gates", "ready_to_execute_now")),
            "automatic_multi_iteration_executor_implemented": _boolish(_nested_get(approval_plan, "executor_input_gates", "automatic_multi_iteration_executor_implemented")),
            "automatic_multi_iteration_execution_allowed_now": _boolish(_nested_get(approval_plan, "executor_input_gates", "automatic_multi_iteration_execution_allowed_now")),
            "future_executor_implemented": _boolish(_nested_get(approval_plan, "future_executor_contract", "implemented")),
            "transaction_started": _boolish(_nested_get(approval_plan, "transaction_plan", "transaction_started")),
            "journal_written_now": _boolish(_nested_get(approval_plan, "transaction_plan", "journal_written_now")),
            "next_action": approval_plan.get("next_action"),
        ...
        "approved_iterations": [
            ...
            for item in approved_iterations
        ],
        "executor_input_gates": {
            "ready_to_execute_now": False,
            "approval_recorded": approved_for_execution,
        ...
        "checks": _automatic_loop_multi_iteration_executor_approval_record_checks(
            approval_plan=approval_plan,
            reviewer=reviewer,
            decision=decision,
            mode=mode,
        ...
        "blockers": blockers,
        "next_action": _automatic_loop_multi_iteration_executor_approval_record_next_action(status=status, blockers=blockers),
        "metadata": {
            **(metadata or {}),
            "tool": "record_paused_session_automatic_loop_multi_iteration_executor_approval",
            "artifact_read": artifact_read,
            "legacy_path": "workspace/paused-session-automatic-loop-multi-iteration-executor-approval-record.json",
            "future_path": "/workspace/debugger/paused-session-automatic-loop-multi-iteration-executor-approval-record.json",
            "path": str(result_path),
        },
        "side_effect_policy": _automatic_loop_multi_iteration_executor_approval_record_side_effect_policy(written=written),
    }
    if written:
        _write_json(result_path, payload)
    return payload
...
def review_paused_session_automatic_loop_multi_iteration_transaction_preflight_payload(
    *,
    approval_plan_json: str | None = None,
    approval_plan_ref: str | None = None,
    approval_record_json: str | None = None,
    ...
    """Build a read-only multi-iteration transaction / journal preflight descriptor."""
    ...
    plan_digest = _stable_json_digest(approval_plan) if approval_plan else None
    blockers = _automatic_loop_multi_iteration_transaction_preflight_blockers(
        approval_plan=approval_plan,
    ...
    execution_plan_id = _string(approval_plan.get("execution_plan_id") or approval_record.get("execution_plan_id"))
    preflight_id = _string(approval_plan.get("preflight_id") or approval_record.get("preflight_id"))
    policy_id = _string(approval_plan.get("policy_id") or approval_record.get("policy_id"))
    transaction_plan = approval_plan.get("transaction_plan") if isinstance(approval_plan.get("transaction_plan"), dict) else {}
    transaction_id = _string(transaction_plan.get("transaction_id") or f"automatic-loop-multi-iteration-executor-transaction:{preflight_id or policy_id or 'unbound'}")
    transaction_preflight_id = f"automatic-loop-multi-iteration-transaction-preflight:{approval_record_id or approval_plan_id or preflight_id or 'unbound'}"
    journal_artifact = transaction_plan.get("journal_artifact") or "workspace/paused-session-automatic-loop-multi-iteration-executor-journal.json"
    result_artifact = transaction_plan.get("result_artifact") or "workspace/paused-session-automatic-loop-multi-iteration-execution-result.json"
    approved_iterations = [item for item in approval_record.get("approved_iterations", []) if isinstance(item, dict)]
    payload: dict[str, Any] = {
        "schema_version": AUTOMATIC_LOOP_MULTI_ITERATION_TRANSACTION_PREFLIGHT_VERSION,
        ...
        "source_approval_record_summary": {
            ...
            "automatic_multi_iteration_loop": _boolish(_nested_get(approval_record, "side_effect_policy", "automatic_multi_iteration_loop")),
        },
        ...
        "planned_journal_entries": [
            {
                "entry_index": index,
                "entry_kind": "planned_multi_iteration_step",
                "iteration_index": item.get("iteration_index"),
                "source_iteration_index": item.get("source_iteration_index"),
                "workflow_step_index": item.get("workflow_step_index"),
                "method": item.get("method"),
            ...
            for index, item in enumerate(approved_iterations)
        ],
        "checks": _automatic_loop_multi_iteration_transaction_preflight_checks(
            approval_plan=approval_plan,
            approval_record=approval_record,
            expected_approval_plan_id=expected_approval_plan_id,
            expected_approval_record_id=expected_approval_record_id,
        ...
        "blockers": blockers,
        "next_action": _automatic_loop_multi_iteration_transaction_preflight_next_action(blockers=blockers),
        "metadata": {
            **(metadata or {}),
            "tool": "review_paused_session_automatic_loop_multi_iteration_transaction_preflight",
            "approval_plan_read": plan_read,
            "approval_record_read": record_read,
            "legacy_path": "workspace/paused-session-automatic-loop-multi-iteration-transaction-preflight.json",
            "future_path": "/workspace/debugger/paused-session-automatic-loop-multi-iteration-transaction-preflight.json",
        },
        "side_effect_policy": _automatic_loop_multi_iteration_transaction_preflight_side_effect_policy(),
    }
    return payload


def record_paused_session_automatic_loop_multi_iteration_transaction_journal_payload(
    *,
    transaction_preflight_json: str | None = None,
    transaction_preflight_ref: str | None = None,
    reviewer: str | None = None,
    ...
    """Build or write the multi-iteration automatic-loop transaction journal payload."""
    ...
    transaction_preflight_id = _string(transaction_preflight.get("transaction_preflight_id"))
    approval_record_id = _string(transaction_preflight.get("approval_record_id"))
    execution_plan_id = _string(transaction_preflight.get("execution_plan_id"))
    preflight_id = _string(transaction_preflight.get("preflight_id"))
    policy_id = _string(transaction_preflight.get("policy_id"))
    preflight_digest = _stable_json_digest(transaction_preflight) if transaction_preflight else None
    result_path = effective_root / "workspace" / "paused-session-automatic-loop-multi-iteration-executor-journal.json"
    blockers = _automatic_loop_multi_iteration_transaction_journal_blockers(
        transaction_preflight=transaction_preflight,
        reviewer=reviewer,
        mode=mode,
        write_result=write_result,
    ...
    status = "blocked" if blockers else "written" if written else "planned"
    created_at = datetime.now(timezone.utc).isoformat()
    journal_id = _automatic_loop_multi_iteration_transaction_journal_id(
        transaction_preflight_id=transaction_preflight_id,
        approval_record_id=approval_record_id,
        transaction_id=transaction_id,
        reviewer=reviewer,
    ...
    for index, item in enumerate(planned_entries, start=1):
        ...
        journal_entries.append(
            {
                "entry_index": index,
                "entry_kind": "planned_multi_iteration_step_journaled",
                "iteration_index": item.get("iteration_index"),
                "source_iteration_index": item.get("source_iteration_index"),
                "workflow_step_index": item.get("workflow_step_index"),
                "method": item.get("method"),
    ...
    payload: dict[str, Any] = {
        "schema_version": AUTOMATIC_LOOP_MULTI_ITERATION_TRANSACTION_JOURNAL_VERSION,
        "status": status,
        "journal_written": written,
        "transaction_started": written,
        "dry_run": not written,
        ...
        "source_transaction_preflight_summary": {
            ...
            "status": transaction_preflight.get("status"),
            "transaction_preflight_ready_for_review": _boolish(transaction_preflight.get("transaction_preflight_ready_for_review")),
            "approval_plan_verified": _boolish(_nested_get(transaction_preflight, "journal_writer_input_gates", "approval_plan_verified")),
            "approval_record_verified": _boolish(_nested_get(transaction_preflight, "journal_writer_input_gates", "approval_record_verified")),
            "ready_to_write_now": _boolish(_nested_get(transaction_preflight, "transaction_plan", "ready_to_write_now")),
            "transaction_started": _boolish(_nested_get(transaction_preflight, "transaction_plan", "transaction_started")),
            "journal_written_now": _boolish(_nested_get(transaction_preflight, "transaction_plan", "journal_written_now")),
            "automatic_multi_iteration_loop": _boolish(_nested_get(transaction_preflight, "journal_writer_input_gates", "automatic_multi_iteration_loop")),
        },
        "journal_entries": journal_entries,
        "journal_summary": {
            "entry_count": len(journal_entries) if written else 0,
            "planned_entry_count": len(journal_entries),
            "planned_iteration_count": max(len(journal_entries) - 1, 0),
            "transaction_started": written,
            "journal_written": written,
            "automatic_loop_executed": False,
            "automatic_multi_iteration_loop": False,
        ...
        "checks": _automatic_loop_multi_iteration_transaction_journal_checks(
            transaction_preflight=transaction_preflight,
            reviewer=reviewer,
            mode=mode,
            write_result=write_result,
        ...
        "blockers": blockers,
        "next_action": _automatic_loop_multi_iteration_transaction_journal_next_action(status=status, blockers=blockers),
        "metadata": {
            **(metadata or {}),
            "tool": "record_paused_session_automatic_loop_multi_iteration_transaction_journal",
            "artifact_read": artifact_read,
            "legacy_path": "workspace/paused-session-automatic-loop-multi-iteration-executor-journal.json",
            "future_path": "/workspace/debugger/paused-session-automatic-loop-multi-iteration-executor-journal.json",
            "path": str(result_path),
        },
        "side_effect_policy": _automatic_loop_multi_iteration_transaction_journal_side_effect_policy(written=written),
    }
    if written:
        _write_json(result_path, payload)
    return payload
...
def _automatic_loop_multi_iteration_executor_approval_record_checks(
    *,
    approval_plan: dict[str, Any],
    reviewer: str | None,
    decision: str,
    ...
    return [
        ...
        {"name": "apply_requires_explicit_approval_record", "passed": mode != "apply" or bool(approve_approval_record), "details": {"approve_approval_record": approve_approval_record}},
        {"name": "expected_approval_plan_id_matches", "passed": not expected_approval_plan_id or approval_plan.get("approval_plan_id") == expected_approval_plan_id, "details": {"expected_approval_plan_id": expected_approval_plan_id, "approval_plan_id": approval_plan.get("approval_plan_id")}},
        {"name": "expected_execution_plan_id_matches", "passed": not expected_execution_plan_id or approval_plan.get("execution_plan_id") == expected_execution_plan_id, "details": {"expected_execution_plan_id": expected_execution_plan_id, "execution_plan_id": approval_plan.get("execution_plan_id")}},
        {"name": "expected_preflight_id_matches", "passed": not expected_preflight_id or approval_plan.get("preflight_id") == expected_preflight_id, "details": {"expected_preflight_id": expected_preflight_id, "preflight_id": approval_plan.get("preflight_id")}},
        {"name": "expected_policy_id_matches", "passed": not expected_policy_id or approval_plan.get("policy_id") == expected_policy_id, "details": {"expected_policy_id": expected_policy_id, "policy_id": approval_plan.get("policy_id")}},
        {"name": "expected_plan_digest_matches", "passed": not expected_plan_digest_sha256 or expected_plan_digest_sha256 == plan_digest, "details": {"expected_plan_digest_sha256": expected_plan_digest_sha256, "approval_plan_digest_sha256": plan_digest}},
        {"name": "approval_plan_does_not_claim_ready_to_execute", "passed": _nested_get(approval_plan, "executor_input_gates", "ready_to_execute_now") is not True, "details": {"ready_to_execute_now": _nested_get(approval_plan, "executor_input_gates", "ready_to_execute_now")}},
        {"name": "multi_iteration_executor_not_implemented", "passed": _nested_get(approval_plan, "executor_input_gates", "automatic_multi_iteration_executor_implemented") is not True and _nested_get(approval_plan, "future_executor_contract", "implemented") is not True, "details": {"automatic_multi_iteration_executor_implemented": _nested_get(approval_plan, "executor_input_gates", "automatic_multi_iteration_executor_implemented"), "future_executor_implemented": _nested_get(approval_plan, "future_executor_contract", "implemented")}},
        {"name": "multi_iteration_execution_not_allowed_now", "passed": _nested_get(approval_plan, "executor_input_gates", "automatic_multi_iteration_execution_allowed_now") is not True, "details": {"automatic_multi_iteration_execution_allowed_now": _nested_get(approval_plan, "executor_input_gates", "automatic_multi_iteration_execution_allowed_now")}},
        {"name": "transaction_not_started", "passed": _nested_get(approval_plan, "transaction_plan", "transaction_started") is not True, "details": {"transaction_started": _nested_get(approval_plan, "transaction_plan", "transaction_started")}},
        {"name": "journal_not_written", "passed": _nested_get(approval_plan, "transaction_plan", "journal_written_now") is not True, "details": {"journal_written_now": _nested_get(approval_plan, "transaction_plan", "journal_written_now")}},
    ]


def _automatic_loop_multi_iteration_executor_approval_record_blockers(**kwargs: Any) -> list[str]:
    return [check["name"] for check in _automatic_loop_multi_iteration_executor_approval_record_checks(**kwargs) if not check["passed"]]


def _automatic_loop_multi_iteration_executor_approval_record_next_action(*, status: str, blockers: list[str]) -> str:
    if blockers:
        return "fix_paused_session_automatic_loop_multi_iteration_executor_approval_record_blockers"
    if status == "planned":
        return "review_then_write_paused_session_automatic_loop_multi_iteration_executor_approval_record"
    return "use_multi_iteration_approval_record_for_future_transaction_preflight"


def _automatic_loop_multi_iteration_executor_approval_record_side_effect_policy(*, written: bool) -> dict[str, Any]:
    return {
        "dry_run_is_read_only": True,
        "writes_approval_record": written,
        "review_decision_recorded": written,
...
def _automatic_loop_multi_iteration_executor_approval_record_id(*, approval_plan_id: str, execution_plan_id: str, preflight_id: str, decision: str, reviewer: str | None, created_at: str) -> str:
    digest = hashlib.sha256(f"{approval_plan_id}\0{execution_plan_id}\0{preflight_id}\0{decision}\0{reviewer or ''}\0{created_at}".encode("utf-8")).hexdigest()[:16]
    return f"automatic-loop-multi-iteration-executor-approval-record:{digest}"
...
def _automatic_loop_multi_iteration_transaction_preflight_checks(
    *,
    approval_plan: dict[str, Any],
    approval_record: dict[str, Any],
    expected_approval_plan_id: str | None,
    ...
    record_execution_plan_id = approval_record.get("execution_plan_id")
    preflight_id = approval_plan.get("preflight_id")
    record_preflight_id = approval_record.get("preflight_id")
    policy_id = approval_plan.get("policy_id")
    record_policy_id = approval_record.get("policy_id")
    return [
        {"name": "approval_plan_available", "passed": bool(approval_plan), "details": {"approval_plan_id": plan_id}},
        {"name": "approval_record_available", "passed": bool(approval_record), "details": {"approval_record_id": approval_record.get("approval_record_id")}},
        {"name": "approval_plan_ready_for_review", "passed": approval_plan.get("status") == "ready_for_review" and approval_plan.get("approval_plan_ready_for_review") is True, "details": {"status": approval_plan.get("status"), "approval_plan_ready_for_review": approval_plan.get("approval_plan_ready_for_review")}},
        ...
        {"name": "approval_record_has_no_blockers", "passed": not record_blockers, "details": {"blockers": record_blockers}},
        {"name": "approval_record_matches_approval_plan_id", "passed": bool(plan_id) and plan_id == record_plan_id, "details": {"approval_plan_id": plan_id, "record_approval_plan_id": record_plan_id}},
        {"name": "approval_record_matches_execution_plan_id", "passed": bool(execution_plan_id) and execution_plan_id == record_execution_plan_id, "details": {"execution_plan_id": execution_plan_id, "record_execution_plan_id": record_execution_plan_id}},
        {"name": "approval_record_matches_preflight_id", "passed": bool(preflight_id) and preflight_id == record_preflight_id, "details": {"preflight_id": preflight_id, "record_preflight_id": record_preflight_id}},
        {"name": "approval_record_matches_policy_id", "passed": bool(policy_id) and policy_id == record_policy_id, "details": {"policy_id": policy_id, "record_policy_id": record_policy_id}},
        {"name": "approval_record_matches_plan_digest", "passed": not approval_record.get("approval_plan_digest_sha256") or approval_record.get("approval_plan_digest_sha256") == plan_digest, "details": {"record_digest": approval_record.get("approval_plan_digest_sha256"), "current_digest": plan_digest}},
        {"name": "expected_approval_plan_id_matches", "passed": not expected_approval_plan_id or plan_id == expected_approval_plan_id, "details": {"expected_approval_plan_id": expected_approval_plan_id, "approval_plan_id": plan_id}},
        {"name": "expected_approval_record_id_matches", "passed": not expected_approval_record_id or approval_record.get("approval_record_id") == expected_approval_record_id, "details": {"expected_approval_record_id": expected_approval_record_id, "approval_record_id": approval_record.get("approval_record_id")}},
        {"name": "expected_execution_plan_id_matches", "passed": not expected_execution_plan_id or execution_plan_id == expected_execution_plan_id, "details": {"expected_execution_plan_id": expected_execution_plan_id, "execution_plan_id": execution_plan_id}},
        {"name": "expected_preflight_id_matches", "passed": not expected_preflight_id or preflight_id == expected_preflight_id, "details": {"expected_preflight_id": expected_preflight_id, "preflight_id": preflight_id}},
        {"name": "expected_policy_id_matches", "passed": not expected_policy_id or policy_id == expected_policy_id, "details": {"expected_policy_id": expected_policy_id, "policy_id": policy_id}},
        {"name": "expected_plan_digest_matches", "passed": not expected_plan_digest_sha256 or expected_plan_digest_sha256 == plan_digest, "details": {"expected_plan_digest_sha256": expected_plan_digest_sha256, "approval_plan_digest_sha256": plan_digest}},
        {"name": "approval_plan_transaction_not_started", "passed": _nested_get(approval_plan, "transaction_plan", "transaction_started") is not True, "details": {"transaction_started": _nested_get(approval_plan, "transaction_plan", "transaction_started")}},
        {"name": "approval_plan_journal_not_written", "passed": _nested_get(approval_plan, "transaction_plan", "journal_written_now") is not True, "details": {"journal_written_now": _nested_get(approval_plan, "transaction_plan", "journal_written_now")}},
        {"name": "approval_record_transaction_not_started", "passed": _nested_get(approval_record, "executor_input_gates", "transaction_started") is not True, "details": {"transaction_started": _nested_get(approval_record, "executor_input_gates", "transaction_started")}},
        {"name": "approval_record_journal_not_written", "passed": _nested_get(approval_record, "executor_input_gates", "journal_written") is not True, "details": {"journal_written": _nested_get(approval_record, "executor_input_gates", "journal_written")}},
        {"name": "approval_record_did_not_execute_multi_iteration_loop", "passed": _nested_get(approval_record, "side_effect_policy", "automatic_multi_iteration_loop") is not True, "details": {"automatic_multi_iteration_loop": _nested_get(approval_record, "side_effect_policy", "automatic_multi_iteration_loop")}},
        {"name": "multi_iteration_executor_not_implemented", "passed": _nested_get(approval_plan, "executor_input_gates", "automatic_multi_iteration_executor_implemented") is not True and _nested_get(approval_plan, "future_executor_contract", "implemented") is not True, "details": {"automatic_multi_iteration_executor_implemented": _nested_get(approval_plan, "executor_input_gates", "automatic_multi_iteration_executor_implemented"), "future_executor_implemented": _nested_get(approval_plan, "future_executor_contract", "implemented")}},
        {"name": "multi_iteration_execution_not_allowed_now", "passed": _nested_get(approval_plan, "executor_input_gates", "automatic_multi_iteration_execution_allowed_now") is not True, "details": {"automatic_multi_iteration_execution_allowed_now": _nested_get(approval_plan, "executor_input_gates", "automatic_multi_iteration_execution_allowed_now")}},
    ]


def _automatic_loop_multi_iteration_transaction_preflight_blockers(**kwargs: Any) -> list[str]:
    return [check["name"] for check in _automatic_loop_multi_iteration_transaction_preflight_checks(**kwargs) if not check["passed"]]


def _automatic_loop_multi_iteration_transaction_preflight_next_action(*, blockers: list[str]) -> str:
    if blockers:
        return "fix_paused_session_automatic_loop_multi_iteration_transaction_preflight_blockers"
    return "review_explicit_paused_session_automatic_loop_multi_iteration_transaction_journal_writer"


def _automatic_loop_multi_iteration_transaction_preflight_side_effect_policy() -> dict[str, Any]:
    policy = _automatic_loop_transaction_preflight_side_effect_policy()
    policy.update({
        "automatic_multi_iteration_loop": False,
...
def _automatic_loop_multi_iteration_transaction_journal_checks(
    *,
    ...
    return [
        ...
        {"name": "approval_plan_verified", "passed": gates.get("approval_plan_verified") is True, "details": {"approval_plan_verified": gates.get("approval_plan_verified")}},
        ...
        {"name": "expected_execution_plan_id_matches", "passed": not expected_execution_plan_id or transaction_preflight.get("execution_plan_id") == expected_execution_plan_id, "details": {"expected_execution_plan_id": expected_execution_plan_id, "execution_plan_id": transaction_preflight.get("execution_plan_id")}},
        ...
        {"name": "expected_policy_id_matches", "passed": not expected_policy_id or transaction_preflight.get("policy_id") == expected_policy_id, "details": {"expected_policy_id": expected_policy_id, "policy_id": transaction_preflight.get("policy_id")}},
        ...
        {"name": "automatic_multi_iteration_loop_not_executed", "passed": gates.get("automatic_multi_iteration_loop") is not True and policy.get("automatic_multi_iteration_loop") is not True and policy.get("automatic_loop_executed") is not True, "details": {"gate_automatic_multi_iteration_loop": gates.get("automatic_multi_iteration_loop"), "policy_automatic_multi_iteration_loop": policy.get("automatic_multi_iteration_loop"), "policy_automatic_loop_executed": policy.get("automatic_loop_executed")}},
...
def _automatic_loop_multi_iteration_transaction_journal_blockers(**kwargs: Any) -> list[str]:
    return [check["name"] for check in _automatic_loop_multi_iteration_transaction_journal_checks(**kwargs) if not check["passed"]]


def _automatic_loop_multi_iteration_transaction_journal_next_action(*, status: str, blockers: list[str]) -> str:
    if blockers:
        return "fix_paused_session_automatic_loop_multi_iteration_transaction_journal_blockers"
    if status == "planned":
        return "review_then_write_paused_session_automatic_loop_multi_iteration_transaction_journal"
    return "review_future_paused_session_automatic_loop_multi_iteration_bounded_executor_gate"


def _automatic_loop_multi_iteration_transaction_journal_id(*, transaction_preflight_id: str, approval_record_id: str, transaction_id: str, reviewer: str | None, created_at: str) -> str:
    ...
    return f"automatic-loop-multi-iteration-transaction-journal:{digest}"
...
def _next_action(status: str, blockers: list[str], warnings: list[str], requested_action: str, live_available: bool) -> str:
    ...
    if "paused_session_automatic_loop_multi_iteration_policy_blocked" in blockers:
        return "inspect_paused_session_automatic_loop_multi_iteration_policy_blockers"
    if "paused_session_automatic_loop_multi_iteration_executor_preflight_blocked" in blockers:
        return "inspect_paused_session_automatic_loop_multi_iteration_executor_preflight_blockers"
    if "paused_session_automatic_loop_multi_iteration_execution_plan_blocked" in blockers:
    ...
    if "paused_session_automatic_loop_multi_iteration_followup_checkpoint_blocked" in blockers:
        return "inspect_paused_session_automatic_loop_multi_iteration_followup_checkpoint_blockers"
    if "paused_session_automatic_loop_multi_iteration_next_step_plan_blocked" in blockers:
    ...
    if "automatic_loop_multi_iteration_policy_requires_executor_review" in warnings:
        return "review_future_paused_session_automatic_loop_multi_iteration_executor_contract"
    if "automatic_loop_multi_iteration_executor_preflight_requires_review" in warnings:
        return "review_future_paused_session_automatic_loop_multi_iteration_executor_preflight"
    if "automatic_loop_multi_iteration_execution_plan_requires_review" in warnings:
    ...
    if "automatic_loop_multi_iteration_followup_checkpoint_requires_next_loop_plan" in warnings:
        return "plan_next_paused_session_loop_iteration_after_multi_iteration"
    if "automatic_loop_multi_iteration_followup_checkpoint_ready_for_next_loop_review" in warnings:
        return "review_next_paused_session_automatic_loop_multi_iteration_step"
    if "automatic_loop_multi_iteration_executor_input_preflight_requires_execution_review" in warnings:
        return "review_paused_session_automatic_loop_multi_iteration_execution"
    if "automatic_loop_multi_iteration_next_step_plan_requires_execution_review" in warnings:
        return "review_paused_session_automatic_loop_multi_iteration_execution"
...
def _review_required_items(
    ...
    automatic_loop_multi_iteration_policy: dict[str, Any],
    ...
    automatic_loop_multi_iteration_followup_checkpoint: dict[str, Any],
    automatic_loop_multi_iteration_next_step_plan: dict[str, Any],
    automatic_loop_multi_iteration_executor_input_preflight: dict[str, Any],
    ...
    automatic_loop_multi_iteration_policy_diagnostics = _automatic_loop_multi_iteration_policy_diagnostics_for_review(automatic_loop_multi_iteration_policy)
    ...
    automatic_loop_multi_iteration_followup_checkpoint_diagnostics = _automatic_loop_multi_iteration_followup_checkpoint_diagnostics_for_review(automatic_loop_multi_iteration_followup_checkpoint)
    automatic_loop_multi_iteration_next_step_plan_diagnostics = _automatic_loop_multi_iteration_next_step_plan_diagnostics_for_review(automatic_loop_multi_iteration_next_step_plan)
    automatic_loop_multi_iteration_executor_input_preflight_diagnostics = _automatic_loop_multi_iteration_executor_input_preflight_diagnostics_for_review(automatic_loop_multi_iteration_executor_input_preflight)
        ...
        items.append(
            {
                ...
                "automatic_loop_multi_iteration_policy_diagnostics": automatic_loop_multi_iteration_policy_diagnostics,
                ...
                "automatic_loop_multi_iteration_followup_checkpoint_diagnostics": automatic_loop_multi_iteration_followup_checkpoint_diagnostics,
                "automatic_loop_multi_iteration_next_step_plan_diagnostics": automatic_loop_multi_iteration_next_step_plan_diagnostics,
                "automatic_loop_multi_iteration_executor_input_preflight_diagnostics": automatic_loop_multi_iteration_executor_input_preflight_diagnostics,
            }
        )
    for code in warnings:
        if code in {
            ...
            "automatic_loop_multi_iteration_policy_requires_executor_review",
            ...
            "automatic_loop_multi_iteration_followup_checkpoint_requires_next_loop_plan",
            "automatic_loop_multi_iteration_followup_checkpoint_ready_for_next_loop_review",
            "automatic_loop_multi_iteration_next_step_plan_requires_execution_review",
            "automatic_loop_multi_iteration_executor_input_preflight_requires_execution_review",
        }:
            items.append(
                {
                    "code": code,
...
def _automatic_loop_multi_iteration_policy_diagnostics_for_review(policy_payload: dict[str, Any]) -> dict[str, Any]:
    side_effect = policy_payload.get("side_effect_policy") if isinstance(policy_payload.get("side_effect_policy"), dict) else {}
    ...
    future = policy_payload.get("future_executor_contract") if isinstance(policy_payload.get("future_executor_contract"), dict) else {}
    return {
        "status": _string(policy_payload.get("status") or "unknown"),
        "ready_for_review": _boolish(policy_payload.get("ready_for_review")),
        "policy_id": _string(policy_payload.get("policy_id")),
        "max_policy_iterations": budget.get("max_policy_iterations", 0),
        "automatic_multi_iteration_executor_implemented": _boolish(budget.get("automatic_multi_iteration_executor_implemented")),
        "automatic_multi_iteration_execution_allowed_now": _boolish(budget.get("automatic_multi_iteration_execution_allowed_now")),
        "requires_review_per_iteration": _boolish(budget.get("requires_review_per_iteration")),
        "requires_checkpoint_after_each_iteration": _boolish(budget.get("requires_checkpoint_after_each_iteration")),
        "requires_fresh_live_callframe_per_iteration": _boolish(budget.get("requires_fresh_live_callframe_per_iteration")),
        "stop_after_each_checkpoint": _boolish(budget.get("stop_after_each_checkpoint")),
        "following_plan_ready": _boolish(source.get("ready_for_review")),
        "fresh_live_callframe_recovered": _boolish(source.get("fresh_live_callframe_recovered")),
        "future_executor_implemented": _boolish(future.get("implemented")),
        "automatic_multi_iteration_loop": _boolish(side_effect.get("automatic_multi_iteration_loop")),
        "loop_advanced": _boolish(side_effect.get("loop_advanced")),
        "queue_advanced": _boolish(side_effect.get("queue_advanced")),
        "calls_mcp": _boolish(side_effect.get("calls_mcp")),
...
def _automatic_loop_multi_iteration_executor_preflight_diagnostics_for_review(preflight: dict[str, Any]) -> dict[str, Any]:
    side_effect = preflight.get("side_effect_policy") if isinstance(preflight.get("side_effect_policy"), dict) else {}
    ...
    source = preflight.get("source_policy") if isinstance(preflight.get("source_policy"), dict) else {}
    return {
        "status": _string(preflight.get("status") or "unknown"),
        "ready_for_review": _boolish(preflight.get("ready_for_review")),
        "preflight_id": _string(preflight.get("preflight_id")),
        "policy_id": _string(preflight.get("policy_id")),
        "policy_ready": _boolish(source.get("ready_for_review")),
        ...
        "ready_to_execute_now": _boolish(gates.get("ready_to_execute_now")),
        "automatic_multi_iteration_executor_implemented": _boolish(gates.get("automatic_multi_iteration_executor_implemented")),
        "automatic_multi_iteration_execution_allowed_now": _boolish(gates.get("automatic_multi_iteration_execution_allowed_now")),
        "requires_transaction_journal": _boolish(gates.get("requires_transaction_journal")),
        "requires_per_iteration_review_gate": _boolish(gates.get("requires_per_iteration_review_gate")),
        "requires_per_iteration_checkpoint_gate": _boolish(gates.get("requires_per_iteration_checkpoint_gate")),
        "requires_fresh_live_callframe_per_iteration": _boolish(gates.get("requires_fresh_live_callframe_per_iteration")),
        "requires_stop_after_each_checkpoint": _boolish(gates.get("requires_stop_after_each_checkpoint")),
        "future_executor_implemented": _boolish(future.get("implemented")),
        "automatic_multi_iteration_loop": _boolish(side_effect.get("automatic_multi_iteration_loop")),
        "loop_advanced": _boolish(side_effect.get("loop_advanced")),
        "queue_advanced": _boolish(side_effect.get("queue_advanced")),
...
def _automatic_loop_multi_iteration_execution_plan_diagnostics_for_review(plan: dict[str, Any]) -> dict[str, Any]:
    side_effect = plan.get("side_effect_policy") if isinstance(plan.get("side_effect_policy"), dict) else {}
    ...
    source = plan.get("source_preflight") if isinstance(plan.get("source_preflight"), dict) else {}
    return {
        "status": _string(plan.get("status") or "unknown"),
        "ready_for_review": _boolish(plan.get("ready_for_review")),
        "execution_plan_id": _string(plan.get("execution_plan_id")),
        "preflight_id": _string(plan.get("preflight_id")),
        "policy_id": _string(plan.get("policy_id")),
        "preflight_ready": _boolish(source.get("ready_for_review")),
...
def _automatic_loop_multi_iteration_executor_approval_plan_diagnostics_for_review(approval_plan: dict[str, Any]) -> dict[str, Any]:
    side_effect = approval_plan.get("side_effect_policy") if isinstance(approval_plan.get("side_effect_policy"), dict) else {}
    ...
    transaction = approval_plan.get("transaction_plan") if isinstance(approval_plan.get("transaction_plan"), dict) else {}
    return {
        "status": _string(approval_plan.get("status") or "unknown"),
        "ready_for_review": _boolish(approval_plan.get("ready_for_review")),
        "approval_plan_id": _string(approval_plan.get("approval_plan_id")),
        "execution_plan_id": _string(approval_plan.get("execution_plan_id")),
        "preflight_id": _string(approval_plan.get("preflight_id")),
        "policy_id": _string(approval_plan.get("policy_id")),
        "execution_plan_ready": _boolish(source.get("ready_for_review")),
        "approved_iteration_count": approval_plan.get("approved_iteration_count", 0),
        "max_approved_iterations": approval_plan.get("max_approved_iterations", 0),
        "ready_to_execute_now": _boolish(gates.get("ready_to_execute_now")),
        "approval_recorded": _boolish(gates.get("approval_recorded")),
        "transaction_started": _boolish(transaction.get("transaction_started")),
        "journal_written": _boolish(transaction.get("journal_written_now")),
        "automatic_multi_iteration_executor_implemented": _boolish(gates.get("automatic_multi_iteration_executor_implemented")),
        "automatic_multi_iteration_execution_allowed_now": _boolish(gates.get("automatic_multi_iteration_execution_allowed_now")),
        "requires_transaction_journal": _boolish(gates.get("requires_transaction_journal")),
        "requires_per_iteration_review_gate": _boolish(gates.get("requires_per_iteration_review_gate")),
...
def _automatic_loop_multi_iteration_next_step_plan_diagnostics_for_review(plan: dict[str, Any]) -> dict[str, Any]:
    return {
        "status": _string(plan.get("status") or "unknown"),
        "ready_for_review": _boolish(plan.get("ready_for_review")),
        "transaction_id": _string(plan.get("transaction_id")),
        "multi_iteration_followup_checkpoint_ready": _boolish(_nested_get(plan, "checkpoint_review", "multi_iteration_followup_checkpoint_ready")),
        "continuation_checkpoint_ready": _boolish(_nested_get(plan, "checkpoint_review", "continuation_checkpoint_ready")),
        "next_loop_plan_ready": _boolish(_nested_get(plan, "next_iteration", "next_loop_plan_ready")),
        "next_iteration_reviewable": _boolish(_nested_get(plan, "next_iteration", "next_iteration_reviewable")),
        "fresh_live_callframe_recovered": _boolish(_nested_get(plan, "next_iteration", "fresh_live_callframe_recovered")),
        "expected_executor": _string(_nested_get(plan, "expected_executor", "name")),
        "step264_executor_mvp": _boolish(_nested_get(plan, "expected_executor", "step264_executor_mvp")),
        "would_execute_multi_iteration": _boolish(_nested_get(plan, "side_effect_policy", "would_execute_multi_iteration")),
        "automatic_multi_iteration_loop": _boolish(_nested_get(plan, "side_effect_policy", "automatic_multi_iteration_loop")),
        "loop_advanced": _boolish(_nested_get(plan, "side_effect_policy", "loop_advanced")),
        "queue_advanced": _boolish(_nested_get(plan, "side_effect_policy", "queue_advanced")),
        "calls_mcp": _boolish(_nested_get(plan, "side_effect_policy", "calls_mcp")),
        "mobile_runtime_used": _boolish(_nested_get(plan, "side_effect_policy", "mobile_runtime_used")),
        "blockers": plan.get("blockers") if isinstance(plan.get("blockers"), list) else [],
    }



def _automatic_loop_multi_iteration_executor_input_preflight_diagnostics_for_review(preflight: dict[str, Any]) -> dict[str, Any]:
    side_effect = preflight.get("side_effect_policy") if isinstance(preflight.get("side_effect_policy"), dict) else {}
    checks = preflight.get("executor_input_checks") if isinstance(preflight.get("executor_input_checks"), dict) else {}
    expected = preflight.get("expected_executor") if isinstance(preflight.get("expected_executor"), dict) else {}
    next_step = preflight.get("next_step_plan_review") if isinstance(preflight.get("next_step_plan_review"), dict) else {}
    return {
        "status": _string(preflight.get("status") or "unknown"),
        "ready_for_review": _boolish(preflight.get("ready_for_review")),
        "ready_for_execution_review": _boolish(preflight.get("ready_for_execution_review")),
        "ready_to_execute_now": _boolish(preflight.get("ready_to_execute_now")),
        "preflight_id": _string(preflight.get("preflight_id")),
        "transaction_id": _string(preflight.get("transaction_id")),
        "journal_id": _string(preflight.get("journal_id")),
        "next_step_plan_ready": _boolish(checks.get("next_step_plan_ready")),
        "bounded_executor_gate_ready": _boolish(checks.get("bounded_executor_gate_ready")),
        "transaction_journal_written": _boolish(checks.get("transaction_journal_written")),
        "loop_plan_ready": _boolish(checks.get("loop_plan_ready")),
        "workflow_ready": _boolish(checks.get("workflow_ready")),
        "fresh_live_callframe_recovered": _boolish(checks.get("fresh_live_callframe_recovered")),
        "retained_attached_session_available": _boolish(checks.get("retained_attached_session_available")),
        "selected_iteration_ready_for_executor_review": _boolish(checks.get("selected_iteration_ready_for_executor_review")),
        "next_step_followup_checkpoint_ready": _boolish(next_step.get("multi_iteration_followup_checkpoint_ready")),
        "expected_executor": _string(expected.get("name")),
        "step264_executor_mvp": _boolish(expected.get("step264_executor_mvp")),
        "would_execute_multi_iteration": _boolish(side_effect.get("would_execute_multi_iteration")),
        "automatic_multi_iteration_loop": _boolish(side_effect.get("automatic_multi_iteration_loop")),
        "loop_advanced": _boolish(side_effect.get("loop_advanced")),
        "queue_advanced": _boolish(side_effect.get("queue_advanced")),
        "calls_mcp": _boolish(side_effect.get("calls_mcp")),
...
def _automatic_loop_multi_iteration_followup_checkpoint_diagnostics_for_review(checkpoint: dict[str, Any]) -> dict[str, Any]:
    return {
        "status": _string(checkpoint.get("status") or "unknown"),
        "ready_for_review": _boolish(checkpoint.get("ready_for_review")),
        "transaction_id": _string(checkpoint.get("transaction_id")),
        ...
        "next_loop_plan_ready": _boolish(_nested_get(checkpoint, "next_loop_review", "next_loop_plan_ready")),
        "next_iteration_reviewable": _boolish(_nested_get(checkpoint, "next_loop_review", "next_iteration_reviewable")),
        "executed_iteration_count": _nested_get(checkpoint, "execution_summary", "executed_iteration_count"),
        "automatic_multi_iteration_execution_mvp": _boolish(_nested_get(checkpoint, "execution_summary", "automatic_multi_iteration_execution_mvp")),
        "checkpoint_written": _boolish(_nested_get(checkpoint, "side_effect_policy", "checkpoint_written")),
        "automatic_multi_iteration_loop": _boolish(_nested_get(checkpoint, "side_effect_policy", "automatic_multi_iteration_loop")),
        "loop_advanced": _boolish(_nested_get(checkpoint, "side_effect_policy", "loop_advanced")),
        "queue_advanced": _boolish(_nested_get(checkpoint, "side_effect_policy", "queue_advanced")),
        "calls_mcp": _boolish(_nested_get(checkpoint, "side_effect_policy", "calls_mcp")),
        "mobile_runtime_used": _boolish(_nested_get(checkpoint, "side_effect_policy", "mobile_runtime_used")),
