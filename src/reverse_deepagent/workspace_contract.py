...
def default_workspace_artifact_routes() -> tuple[WorkspaceArtifactRoute, ...]:
    ...
    routes = (
        ...
        ("workspace_foldered_canonical_migration_apply_plan", "workspace/workspace-foldered-canonical-migration-apply-plan.json", "/workspace/review/", "workspace-foldered-canonical-migration-apply-plan.json", "triage", ("coordinator", "review")),
        ("workspace_foldered_canonical_migration_approval_plan", "workspace/workspace-foldered-canonical-migration-approval-plan.json", "/workspace/review/", "workspace-foldered-canonical-migration-approval-plan.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_migration_manifest_dry_run", "workspace/workspace-foldered-canonical-migration-manifest-dry-run.json", "/workspace/review/", "workspace-foldered-canonical-migration-manifest-dry-run.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_migration_rollback_checkpoint", "workspace/workspace-foldered-canonical-migration-rollback-checkpoint.json", "/workspace/review/", "workspace-foldered-canonical-migration-rollback-checkpoint.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_migration_post_apply_validation", "workspace/workspace-foldered-canonical-migration-post-apply-validation.json", "/workspace/review/", "workspace-foldered-canonical-migration-post-apply-validation.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_migration_post_apply_validation_result", "workspace/workspace-foldered-canonical-migration-post-apply-validation-result.json", "/workspace/review/", "workspace-foldered-canonical-migration-post-apply-validation-result.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_legacy_fallback_tightening_readiness", "workspace/workspace-foldered-canonical-legacy-fallback-tightening-readiness.json", "/workspace/review/", "workspace-foldered-canonical-legacy-fallback-tightening-readiness.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_legacy_fallback_tightening_plan", "workspace/workspace-foldered-canonical-legacy-fallback-tightening-plan.json", "/workspace/review/", "workspace-foldered-canonical-legacy-fallback-tightening-plan.json", "triage", ("coordinator", "review")),
        ("workspace_foldered_canonical_legacy_fallback_tightening_preflight", "workspace/workspace-foldered-canonical-legacy-fallback-tightening-preflight.json", "/workspace/review/", "workspace-foldered-canonical-legacy-fallback-tightening-preflight.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_legacy_fallback_tightening_result", "workspace/workspace-foldered-canonical-legacy-fallback-tightening-result.json", "/workspace/review/", "workspace-foldered-canonical-legacy-fallback-tightening-result.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_legacy_fallback_tightening_journal", "workspace/workspace-foldered-canonical-legacy-fallback-tightening-journal.json", "/workspace/review/", "workspace-foldered-canonical-legacy-fallback-tightening-journal.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_migration_finalization_readiness", "workspace/workspace-foldered-canonical-migration-finalization-readiness.json", "/workspace/review/", "workspace-foldered-canonical-migration-finalization-readiness.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_migration_finalization_plan", "workspace/workspace-foldered-canonical-migration-finalization-plan.json", "/workspace/review/", "workspace-foldered-canonical-migration-finalization-plan.json", "triage", ("coordinator", "review")),
        ("workspace_foldered_canonical_migration_finalization_preflight", "workspace/workspace-foldered-canonical-migration-finalization-preflight.json", "/workspace/review/", "workspace-foldered-canonical-migration-finalization-preflight.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_migration_finalization_result", "workspace/workspace-foldered-canonical-migration-finalization-result.json", "/workspace/review/", "workspace-foldered-canonical-migration-finalization-result.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_migration_finalization_journal", "workspace/workspace-foldered-canonical-migration-finalization-journal.json", "/workspace/review/", "workspace-foldered-canonical-migration-finalization-journal.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_migration_post_finalization_audit", "workspace/workspace-foldered-canonical-migration-post-finalization-audit.json", "/workspace/review/", "workspace-foldered-canonical-migration-post-finalization-audit.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_broader_rollout_readiness", "workspace/workspace-foldered-canonical-broader-rollout-readiness.json", "/workspace/review/", "workspace-foldered-canonical-broader-rollout-readiness.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_broader_rollout_plan", "workspace/workspace-foldered-canonical-broader-rollout-plan.json", "/workspace/review/", "workspace-foldered-canonical-broader-rollout-plan.json", "triage", ("coordinator", "review")),
        ("workspace_foldered_canonical_broader_rollout_preflight", "workspace/workspace-foldered-canonical-broader-rollout-preflight.json", "/workspace/review/", "workspace-foldered-canonical-broader-rollout-preflight.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_broader_rollout_result", "workspace/workspace-foldered-canonical-broader-rollout-result.json", "/workspace/review/", "workspace-foldered-canonical-broader-rollout-result.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_broader_rollout_journal", "workspace/workspace-foldered-canonical-broader-rollout-journal.json", "/workspace/review/", "workspace-foldered-canonical-broader-rollout-journal.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_broader_rollout_post_audit", "workspace/workspace-foldered-canonical-broader-rollout-post-audit.json", "/workspace/review/", "workspace-foldered-canonical-broader-rollout-post-audit.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_broader_rollout_rollback_decision_plan", "workspace/workspace-foldered-canonical-broader-rollout-rollback-decision-plan.json", "/workspace/review/", "workspace-foldered-canonical-broader-rollout-rollback-decision-plan.json", "triage", ("coordinator", "review")),
        ("workspace_foldered_canonical_broader_rollout_decision_record", "workspace/workspace-foldered-canonical-broader-rollout-decision-record.json", "/workspace/review/", "workspace-foldered-canonical-broader-rollout-decision-record.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_broader_rollout_commit_result", "workspace/workspace-foldered-canonical-broader-rollout-commit-result.json", "/workspace/review/", "workspace-foldered-canonical-broader-rollout-commit-result.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_broader_rollout_commit_journal", "workspace/workspace-foldered-canonical-broader-rollout-commit-journal.json", "/workspace/review/", "workspace-foldered-canonical-broader-rollout-commit-journal.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_broader_rollout_rollback_preflight", "workspace/workspace-foldered-canonical-broader-rollout-rollback-preflight.json", "/workspace/review/", "workspace-foldered-canonical-broader-rollout-rollback-preflight.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_broader_rollout_rollback_result", "workspace/workspace-foldered-canonical-broader-rollout-rollback-result.json", "/workspace/review/", "workspace-foldered-canonical-broader-rollout-rollback-result.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_broader_rollout_rollback_journal", "workspace/workspace-foldered-canonical-broader-rollout-rollback-journal.json", "/workspace/review/", "workspace-foldered-canonical-broader-rollout-rollback-journal.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_migration_physical_apply_preflight", "workspace/workspace-foldered-canonical-migration-physical-apply-preflight.json", "/workspace/review/", "workspace-foldered-canonical-migration-physical-apply-preflight.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_migration_physical_apply_result", "workspace/workspace-foldered-canonical-migration-physical-apply-result.json", "/workspace/review/", "workspace-foldered-canonical-migration-physical-apply-result.json", "audit", ("coordinator", "review")),
        ("workspace_foldered_canonical_migration_physical_apply_journal", "workspace/workspace-foldered-canonical-migration-physical-apply-journal.json", "/workspace/review/", "workspace-foldered-canonical-migration-physical-apply-journal.json", "audit", ("coordinator", "review")),
        ...
        ("workspace_paused_session_cross_process_execution_plan", "workspace/paused-session-cross-process-execution-plan.json", "/workspace/debugger/", "paused-session-cross-process-execution-plan.json", "triage", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_cross_process_session_lifecycle", "workspace/paused-session-cross-process-session-lifecycle.json", "/workspace/debugger/", "paused-session-cross-process-session-lifecycle.json", "triage", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_cross_process_attach_probe", "workspace/paused-session-cross-process-attach-probe.json", "/workspace/debugger/", "paused-session-cross-process-attach-probe.json", "audit", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_live_callframe_recovery", "workspace/paused-session-live-callframe-recovery.json", "/workspace/debugger/", "paused-session-live-callframe-recovery.json", "audit", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_cross_process_one_action_execution", "workspace/paused-session-cross-process-one-action-execution.json", "/workspace/debugger/", "paused-session-cross-process-one-action-execution.json", "audit", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_next_paused_event_capture_plan", "workspace/paused-session-next-paused-event-capture-plan.json", "/workspace/debugger/", "paused-session-next-paused-event-capture-plan.json", "triage", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_next_paused_event_capture_execution", "workspace/paused-session-next-paused-event-capture-execution.json", "/workspace/debugger/", "paused-session-next-paused-event-capture-execution.json", "audit", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_pre_action_subscribe_and_action", "workspace/paused-session-pre-action-subscribe-and-action.json", "/workspace/debugger/", "paused-session-pre-action-subscribe-and-action.json", "audit", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_cross_process_continuation_checkpoint", "workspace/paused-session-cross-process-continuation-checkpoint.json", "/workspace/debugger/", "paused-session-cross-process-continuation-checkpoint.json", "audit", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_multi_step_continuation_workflow", "workspace/paused-session-multi-step-continuation-workflow.json", "/workspace/debugger/", "paused-session-multi-step-continuation-workflow.json", "triage", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_multi_step_continuation_execution", "workspace/paused-session-multi-step-continuation-execution.json", "/workspace/debugger/", "paused-session-multi-step-continuation-execution.json", "audit", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_multi_step_loop_plan", "workspace/paused-session-multi-step-loop-plan.json", "/workspace/debugger/", "paused-session-multi-step-loop-plan.json", "triage", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_multi_step_loop_execution", "workspace/paused-session-multi-step-loop-execution.json", "/workspace/debugger/", "paused-session-multi-step-loop-execution.json", "audit", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_automatic_loop_readiness", "workspace/paused-session-automatic-loop-readiness.json", "/workspace/debugger/", "paused-session-automatic-loop-readiness.json", "triage", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_automatic_loop_execution_plan", "workspace/paused-session-automatic-loop-execution-plan.json", "/workspace/debugger/", "paused-session-automatic-loop-execution-plan.json", "triage", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_automatic_loop_executor_preflight", "workspace/paused-session-automatic-loop-executor-preflight.json", "/workspace/debugger/", "paused-session-automatic-loop-executor-preflight.json", "triage", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_automatic_loop_executor_approval_plan", "workspace/paused-session-automatic-loop-executor-approval-plan.json", "/workspace/debugger/", "paused-session-automatic-loop-executor-approval-plan.json", "triage", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_automatic_loop_executor_approval_record", "workspace/paused-session-automatic-loop-executor-approval-record.json", "/workspace/debugger/", "paused-session-automatic-loop-executor-approval-record.json", "audit", ("debugger", "review")),
        ("workspace_paused_session_automatic_loop_transaction_preflight", "workspace/paused-session-automatic-loop-transaction-preflight.json", "/workspace/debugger/", "paused-session-automatic-loop-transaction-preflight.json", "audit", ("debugger", "review")),
        ("workspace_paused_session_automatic_loop_executor_journal", "workspace/paused-session-automatic-loop-executor-journal.json", "/workspace/debugger/", "paused-session-automatic-loop-executor-journal.json", "audit", ("debugger", "review")),
        ("workspace_paused_session_automatic_loop_bounded_executor_gate", "workspace/paused-session-automatic-loop-bounded-executor-gate.json", "/workspace/debugger/", "paused-session-automatic-loop-bounded-executor-gate.json", "audit", ("debugger", "review")),
        ("workspace_paused_session_automatic_loop_execution_result", "workspace/paused-session-automatic-loop-execution-result.json", "/workspace/debugger/", "paused-session-automatic-loop-execution-result.json", "audit", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_automatic_loop_followup_checkpoint", "workspace/paused-session-automatic-loop-followup-checkpoint.json", "/workspace/debugger/", "paused-session-automatic-loop-followup-checkpoint.json", "audit", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_automatic_loop_next_iteration_plan", "workspace/paused-session-automatic-loop-next-iteration-plan.json", "/workspace/debugger/", "paused-session-automatic-loop-next-iteration-plan.json", "triage", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_automatic_loop_next_iteration_execution", "workspace/paused-session-automatic-loop-next-iteration-execution.json", "/workspace/debugger/", "paused-session-automatic-loop-next-iteration-execution.json", "audit", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_automatic_loop_next_iteration_followup_checkpoint", "workspace/paused-session-automatic-loop-next-iteration-followup-checkpoint.json", "/workspace/debugger/", "paused-session-automatic-loop-next-iteration-followup-checkpoint.json", "audit", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_automatic_loop_following_iteration_plan", "workspace/paused-session-automatic-loop-following-iteration-plan.json", "/workspace/debugger/", "paused-session-automatic-loop-following-iteration-plan.json", "triage", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_automatic_loop_multi_iteration_policy", "workspace/paused-session-automatic-loop-multi-iteration-policy.json", "/workspace/debugger/", "paused-session-automatic-loop-multi-iteration-policy.json", "triage", ("debugger", "browser_runtime", "review")),
        ...
        ("workspace_paused_session_automatic_loop_multi_iteration_transaction_preflight", "workspace/paused-session-automatic-loop-multi-iteration-transaction-preflight.json", "/workspace/debugger/", "paused-session-automatic-loop-multi-iteration-transaction-preflight.json", "audit", ("debugger", "review")),
        ("workspace_paused_session_automatic_loop_multi_iteration_executor_journal", "workspace/paused-session-automatic-loop-multi-iteration-executor-journal.json", "/workspace/debugger/", "paused-session-automatic-loop-multi-iteration-executor-journal.json", "audit", ("debugger", "review")),
        ("workspace_paused_session_automatic_loop_multi_iteration_bounded_executor_gate", "workspace/paused-session-automatic-loop-multi-iteration-bounded-executor-gate.json", "/workspace/debugger/", "paused-session-automatic-loop-multi-iteration-bounded-executor-gate.json", "audit", ("debugger", "review")),
        ("workspace_paused_session_automatic_loop_multi_iteration_execution_result", "workspace/paused-session-automatic-loop-multi-iteration-execution-result.json", "/workspace/debugger/", "paused-session-automatic-loop-multi-iteration-execution-result.json", "audit", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_automatic_loop_multi_iteration_followup_checkpoint", "workspace/paused-session-automatic-loop-multi-iteration-followup-checkpoint.json", "/workspace/debugger/", "paused-session-automatic-loop-multi-iteration-followup-checkpoint.json", "audit", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_automatic_loop_multi_iteration_next_step_plan", "workspace/paused-session-automatic-loop-multi-iteration-next-step-plan.json", "/workspace/debugger/", "paused-session-automatic-loop-multi-iteration-next-step-plan.json", "triage", ("debugger", "browser_runtime", "review")),
        ("workspace_paused_session_automatic_loop_multi_iteration_executor_input_preflight", "workspace/paused-session-automatic-loop-multi-iteration-executor-input-preflight.json", "/workspace/debugger/", "paused-session-automatic-loop-multi-iteration-executor-input-preflight.json", "triage", ("debugger", "browser_runtime", "review")),
        ...
        ("workspace_closure_wrapper_runtime_mutability_preflight", "workspace/closure-wrapper-runtime-mutability-preflight.json", "/workspace/hooks/", "closure-wrapper-runtime-mutability-preflight.json", "triage", ("debugger", "hook", "review")),
        ("workspace_closure_wrapper_runtime_mutability_result", "workspace/closure-wrapper-runtime-mutability-result.json", "/workspace/hooks/", "closure-wrapper-runtime-mutability-result.json", "audit", ("debugger", "hook", "review")),
        ...
        ("workspace_closure_wrapper_continuation_execution_plan", "workspace/closure-wrapper-continuation-execution-plan.json", "/workspace/hooks/", "closure-wrapper-continuation-execution-plan.json", "triage", ("debugger", "hook", "review")),
        ("workspace_closure_wrapper_continuation_execution", "workspace/closure-wrapper-continuation-execution.json", "/workspace/hooks/", "closure-wrapper-continuation-execution.json", "audit", ("debugger", "hook", "review")),
        ("workspace_closure_wrapper_continuation_checkpoint", "workspace/closure-wrapper-continuation-checkpoint.json", "/workspace/hooks/", "closure-wrapper-continuation-checkpoint.json", "triage", ("debugger", "hook", "review")),
        ("workspace_closure_wrapper_continuation_next_iteration_plan", "workspace/closure-wrapper-continuation-next-iteration-plan.json", "/workspace/hooks/", "closure-wrapper-continuation-next-iteration-plan.json", "triage", ("debugger", "hook", "review")),
        ("workspace_closure_wrapper_continuation_next_iteration_execution", "workspace/closure-wrapper-continuation-next-iteration-execution.json", "/workspace/hooks/", "closure-wrapper-continuation-next-iteration-execution.json", "audit", ("debugger", "hook", "review")),
        ...
        ("workspace_async_chunk_traversal_graph", "workspace/async-chunk-traversal-graph.json", "/workspace/runtime/", "async-chunk-traversal-graph.json", "triage", ("hook", "browser_runtime", "review")),
        ("workspace_async_chunk_traversal_workflow_plan", "workspace/async-chunk-traversal-workflow-plan.json", "/workspace/runtime/", "async-chunk-traversal-workflow-plan.json", "triage", ("hook", "browser_runtime", "review")),
        ("workspace_async_chunk_traversal_workflow_execution", "workspace/async-chunk-traversal-workflow-execution.json", "/workspace/runtime/", "async-chunk-traversal-workflow-execution.json", "audit", ("hook", "browser_runtime", "review")),
        ("workspace_async_chunk_traversal_loop_plan", "workspace/async-chunk-traversal-loop-plan.json", "/workspace/runtime/", "async-chunk-traversal-loop-plan.json", "triage", ("hook", "browser_runtime", "review")),
        ("workspace_async_chunk_traversal_loop_execution", "workspace/async-chunk-traversal-loop-execution.json", "/workspace/runtime/", "async-chunk-traversal-loop-execution.json", "audit", ("hook", "browser_runtime", "review")),
        ("workspace_async_chunk_recursive_traversal_plan", "workspace/async-chunk-recursive-traversal-plan.json", "/workspace/runtime/", "async-chunk-recursive-traversal-plan.json", "triage", ("hook", "browser_runtime", "review")),
        ("workspace_async_chunk_recursive_traversal_followup", "workspace/async-chunk-recursive-traversal-followup.json", "/workspace/runtime/", "async-chunk-recursive-traversal-followup.json", "audit", ("hook", "browser_runtime", "review")),
        ("workspace_async_chunk_recursive_traversal_execution", "workspace/async-chunk-recursive-traversal-execution.json", "/workspace/runtime/", "async-chunk-recursive-traversal-execution.json", "audit", ("hook", "browser_runtime", "review")),
        ...
        ("workspace_custom_loader_traversal_workflow_plan", "workspace/custom-loader-traversal-workflow-plan.json", "/workspace/runtime/", "custom-loader-traversal-workflow-plan.json", "triage", ("hook", "browser_runtime", "review")),
        ("workspace_custom_loader_traversal_workflow_execution", "workspace/custom-loader-traversal-workflow-execution.json", "/workspace/runtime/", "custom-loader-traversal-workflow-execution.json", "audit", ("hook", "browser_runtime", "review")),
        ("workspace_custom_loader_traversal_loop_plan", "workspace/custom-loader-traversal-loop-plan.json", "/workspace/runtime/", "custom-loader-traversal-loop-plan.json", "triage", ("hook", "browser_runtime", "review")),
        ("workspace_custom_loader_traversal_loop_execution", "workspace/custom-loader-traversal-loop-execution.json", "/workspace/runtime/", "custom-loader-traversal-loop-execution.json", "audit", ("hook", "browser_runtime", "review")),
        ("workspace_custom_loader_recursive_traversal_plan", "workspace/custom-loader-recursive-traversal-plan.json", "/workspace/runtime/", "custom-loader-recursive-traversal-plan.json", "triage", ("hook", "browser_runtime", "review")),
        ("workspace_custom_loader_recursive_traversal_followup", "workspace/custom-loader-recursive-traversal-followup.json", "/workspace/runtime/", "custom-loader-recursive-traversal-followup.json", "audit", ("hook", "browser_runtime", "review")),
        ("workspace_custom_loader_recursive_traversal_execution", "workspace/custom-loader-recursive-traversal-execution.json", "/workspace/runtime/", "custom-loader-recursive-traversal-execution.json", "audit", ("hook", "browser_runtime", "review")),
        ...
        ("workspace_module_federation_traversal_graph", "workspace/module-federation-traversal-graph.json", "/workspace/runtime/", "module-federation-traversal-graph.json", "triage", ("hook", "browser_runtime", "review")),
        ("workspace_module_federation_traversal_workflow_plan", "workspace/module-federation-traversal-workflow-plan.json", "/workspace/runtime/", "module-federation-traversal-workflow-plan.json", "triage", ("hook", "browser_runtime", "review")),
        ("workspace_module_federation_traversal_workflow_execution", "workspace/module-federation-traversal-workflow-execution.json", "/workspace/runtime/", "module-federation-traversal-workflow-execution.json", "audit", ("hook", "browser_runtime", "review")),
        ("workspace_module_federation_recursive_traversal_plan", "workspace/module-federation-recursive-traversal-plan.json", "/workspace/runtime/", "module-federation-recursive-traversal-plan.json", "triage", ("hook", "browser_runtime", "review")),
        ("workspace_module_federation_recursive_traversal_followup", "workspace/module-federation-recursive-traversal-followup.json", "/workspace/runtime/", "module-federation-recursive-traversal-followup.json", "audit", ("hook", "browser_runtime", "review")),
        ("workspace_module_federation_recursive_traversal_execution", "workspace/module-federation-recursive-traversal-execution.json", "/workspace/runtime/", "module-federation-recursive-traversal-execution.json", "audit", ("hook", "browser_runtime", "review")),
        ("workspace_module_federation_recursive_continuation_journal", "workspace/module-federation-recursive-continuation-journal.json", "/workspace/runtime/", "module-federation-recursive-continuation-journal.json", "audit", ("hook", "browser_runtime", "review")),
        ("workspace_module_federation_recursive_continuation_checkpoint", "workspace/module-federation-recursive-continuation-checkpoint.json", "/workspace/runtime/", "module-federation-recursive-continuation-checkpoint.json", "audit", ("hook", "browser_runtime", "review")),
        ("workspace_recursive_continuation_readiness", "workspace/recursive-continuation-readiness.json", "/workspace/runtime/", "recursive-continuation-readiness.json", "audit", ("hook", "browser_runtime", "review")),
        ...
        ("workspace_source_map_followthrough_chain_readiness", "workspace/source-map-followthrough-chain-readiness.json", "/workspace/debugger/", "source-map-followthrough-chain-readiness.json", "triage", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_followthrough_one_step_plan", "workspace/source-map-followthrough-one-step-plan.json", "/workspace/debugger/", "source-map-followthrough-one-step-plan.json", "triage", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_followthrough_dispatch_preflight", "workspace/source-map-followthrough-dispatch-preflight.json", "/workspace/debugger/", "source-map-followthrough-dispatch-preflight.json", "triage", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_followthrough_dispatch_approval_plan", "workspace/source-map-followthrough-dispatch-approval-plan.json", "/workspace/debugger/", "source-map-followthrough-dispatch-approval-plan.json", "triage", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_followthrough_dispatch_approval_record", "workspace/source-map-followthrough-dispatch-approval-record.json", "/workspace/debugger/", "source-map-followthrough-dispatch-approval-record.json", "audit", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_followthrough_dispatch_transaction_preflight", "workspace/source-map-followthrough-dispatch-transaction-preflight.json", "/workspace/debugger/", "source-map-followthrough-dispatch-transaction-preflight.json", "audit", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_followthrough_dispatch_transaction_journal", "workspace/source-map-followthrough-dispatch-transaction-journal.json", "/workspace/debugger/", "source-map-followthrough-dispatch-transaction-journal.json", "audit", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_followthrough_dispatch_bounded_executor_gate", "workspace/source-map-followthrough-dispatch-bounded-executor-gate.json", "/workspace/debugger/", "source-map-followthrough-dispatch-bounded-executor-gate.json", "audit", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_followthrough_dispatcher_handoff", "workspace/source-map-followthrough-dispatcher-handoff.json", "/workspace/debugger/", "source-map-followthrough-dispatcher-handoff.json", "audit", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_followthrough_dispatcher_apply_preflight", "workspace/source-map-followthrough-dispatcher-apply-preflight.json", "/workspace/debugger/", "source-map-followthrough-dispatcher-apply-preflight.json", "audit", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_followthrough_dispatcher_result", "workspace/source-map-followthrough-dispatcher-result.json", "/workspace/debugger/", "source-map-followthrough-dispatcher-result.json", "audit", ("debugger", "hook", "review", "rebuild")),
        ...
        ("workspace_source_map_selected_executor_input_review", "workspace/source-map-selected-executor-input-review.json", "/workspace/debugger/", "source-map-selected-executor-input-review.json", "triage", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_selected_executor_approval_plan", "workspace/source-map-selected-executor-approval-plan.json", "/workspace/debugger/", "source-map-selected-executor-approval-plan.json", "triage", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_selected_executor_approval_record", "workspace/source-map-selected-executor-approval-record.json", "/workspace/debugger/", "source-map-selected-executor-approval-record.json", "audit", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_selected_executor_apply_preflight", "workspace/source-map-selected-executor-apply-preflight.json", "/workspace/debugger/", "source-map-selected-executor-apply-preflight.json", "audit", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_selected_executor_application_handoff", "workspace/source-map-selected-executor-application-handoff.json", "/workspace/debugger/", "source-map-selected-executor-application-handoff.json", "audit", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_selected_executor_result_checkpoint", "workspace/source-map-selected-executor-result-checkpoint.json", "/workspace/debugger/", "source-map-selected-executor-result-checkpoint.json", "audit", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_followthrough_completion_checkpoint", "workspace/source-map-followthrough-completion-checkpoint.json", "/workspace/debugger/", "source-map-followthrough-completion-checkpoint.json", "audit", ("debugger", "hook", "review", "rebuild")),
        ("workspace_source_map_terminal_review_package", "workspace/source-map-terminal-review-package.json", "/workspace/review/", "source-map-terminal-review-package.json", "audit", ("review", "debugger", "hook", "rebuild")),
        ("workspace_source_map_terminal_review_closure_checkpoint", "workspace/source-map-terminal-review-closure-checkpoint.json", "/workspace/review/", "source-map-terminal-review-closure-checkpoint.json", "audit", ("review", "debugger", "hook", "rebuild")),
        ("workspace_source_map_terminal_review_final_audit", "workspace/source-map-terminal-review-final-audit.json", "/workspace/review/", "source-map-terminal-review-final-audit.json", "audit", ("review", "debugger", "hook", "rebuild")),
        ("workspace_source_map_source_logpoint_install_result", "workspace/source-map-source-logpoint-install-result.json", "/workspace/debugger/", "source-map-source-logpoint-install-result.json", "audit", ("debugger", "hook", "review")),
        ("workspace_source_map_debugger_candidates", "workspace/source-map-debugger-candidates.json", "/workspace/debugger/", "source-map-debugger-candidates.json", "triage", ("debugger", "review", "hook")),
        ("workspace_source_map_debugger_candidate_selection", "workspace/source-map-debugger-candidate-selection.json", "/workspace/debugger/", "source-map-debugger-candidate-selection.json", "triage", ("debugger", "review", "hook")),
        ("workspace_source_map_debugger_execution_result", "workspace/source-map-debugger-execution-result.json", "/workspace/debugger/", "source-map-debugger-execution-result.json", "audit", ("debugger", "review", "hook")),
        ("workspace_source_map_hook_candidates", "workspace/source-map-hook-candidates.json", "/workspace/hooks/", "source-map-hook-candidates.json", "triage", ("hook", "review", "debugger")),
        ("workspace_source_map_hook_candidate_selection", "workspace/source-map-hook-candidate-selection.json", "/workspace/hooks/", "source-map-hook-candidate-selection.json", "triage", ("hook", "review", "debugger")),
        ("workspace_source_map_hook_install_result", "workspace/source-map-hook-install-result.json", "/workspace/hooks/", "source-map-hook-install-result.json", "audit", ("hook", "review", "debugger")),
        ("workspace_source_map_rebuild_result", "workspace/source-map-rebuild-result.json", "/workspace/rebuild/", "source-map-rebuild-result.json", "audit", ("rebuild", "review", "debugger")),
        ("workspace_source_map_rebuild_generation_result", "workspace/source-map-rebuild-generation-result.json", "/workspace/rebuild/", "source-map-rebuild-generation-result.json", "audit", ("rebuild", "review", "debugger")),
        ...
        ("workspace_object_graph_diff", "workspace/object-graph-diff.json", "/workspace/browser/", "object-graph-diff.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_runtime_object_graph_diff", "workspace/runtime-object-graph-diff.json", "/workspace/browser/", "runtime-object-graph-diff.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_readiness", "workspace/heap-snapshot-readiness.json", "/workspace/browser/", "heap-snapshot-readiness.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_collect", "workspace/heap-snapshot-collect.json", "/workspace/browser/", "heap-snapshot-collect.json", "audit", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_diff_readiness", "workspace/heap-snapshot-diff-readiness.json", "/workspace/browser/", "heap-snapshot-diff-readiness.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_diff_executor_preflight", "workspace/heap-snapshot-diff-executor-preflight.json", "/workspace/browser/", "heap-snapshot-diff-executor-preflight.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_diff_executor_approval_plan", "workspace/heap-snapshot-diff-executor-approval-plan.json", "/workspace/browser/", "heap-snapshot-diff-executor-approval-plan.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_diff_executor_approval_record", "workspace/heap-snapshot-diff-executor-approval-record.json", "/workspace/browser/", "heap-snapshot-diff-executor-approval-record.json", "audit", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_diff_executor_transaction_preflight", "workspace/heap-snapshot-diff-executor-transaction-preflight.json", "/workspace/browser/", "heap-snapshot-diff-executor-transaction-preflight.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_diff_executor_transaction_journal", "workspace/heap-snapshot-diff-executor-journal.json", "/workspace/browser/", "heap-snapshot-diff-executor-journal.json", "audit", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_diff_executor_bounded_gate", "workspace/heap-snapshot-diff-executor-bounded-gate.json", "/workspace/browser/", "heap-snapshot-diff-executor-bounded-gate.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_diff_executor_result", "workspace/heap-snapshot-diff-executor-result.json", "/workspace/browser/", "heap-snapshot-diff-executor-result.json", "audit", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_diff_followup_checkpoint", "workspace/heap-snapshot-diff-followup-checkpoint.json", "/workspace/browser/", "heap-snapshot-diff-followup-checkpoint.json", "audit", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_diff_selected_analysis_input_preflight", "workspace/heap-snapshot-diff-selected-analysis-input-preflight.json", "/workspace/browser/", "heap-snapshot-diff-selected-analysis-input-preflight.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_constructor_growth_drilldown", "workspace/heap-snapshot-constructor-growth-drilldown.json", "/workspace/browser/", "heap-snapshot-constructor-growth-drilldown.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_constructor_growth_drilldown_analysis", "workspace/heap-snapshot-constructor-growth-drilldown-analysis.json", "/workspace/browser/", "heap-snapshot-constructor-growth-drilldown-analysis.json", "audit", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_automatic_followup_plan", "workspace/heap-snapshot-automatic-followup-plan.json", "/workspace/browser/", "heap-snapshot-automatic-followup-plan.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_retained_size_proof_plan", "workspace/heap-snapshot-retained-size-proof-plan.json", "/workspace/browser/", "heap-snapshot-retained-size-proof-plan.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_path_to_root_proof_plan", "workspace/heap-snapshot-path-to-root-proof-plan.json", "/workspace/browser/", "heap-snapshot-path-to-root-proof-plan.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_raw_heap_constructor_drilldown_proof_plan", "workspace/heap-snapshot-raw-heap-constructor-drilldown-proof-plan.json", "/workspace/browser/", "heap-snapshot-raw-heap-constructor-drilldown-proof-plan.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_retained_path_preflight", "workspace/heap-snapshot-retained-path-preflight.json", "/workspace/browser/", "heap-snapshot-retained-path-preflight.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_retained_size_input_review", "workspace/heap-snapshot-retained-size-input-review.json", "/workspace/browser/", "heap-snapshot-retained-size-input-review.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_retained_size_approval_plan", "workspace/heap-snapshot-retained-size-approval-plan.json", "/workspace/browser/", "heap-snapshot-retained-size-approval-plan.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_retained_size_approval_record", "workspace/heap-snapshot-retained-size-approval-record.json", "/workspace/browser/", "heap-snapshot-retained-size-approval-record.json", "audit", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_retained_size_transaction_preflight", "workspace/heap-snapshot-retained-size-transaction-preflight.json", "/workspace/browser/", "heap-snapshot-retained-size-transaction-preflight.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_retained_size_transaction_journal", "workspace/heap-snapshot-retained-size-executor-journal.json", "/workspace/browser/", "heap-snapshot-retained-size-executor-journal.json", "audit", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_retained_size_bounded_gate", "workspace/heap-snapshot-retained-size-bounded-gate.json", "/workspace/browser/", "heap-snapshot-retained-size-bounded-gate.json", "triage", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_retained_size_analysis", "workspace/heap-snapshot-retained-size-analysis.json", "/workspace/browser/", "heap-snapshot-retained-size-analysis.json", "audit", ("browser_runtime", "hook", "review")),
        ("workspace_heap_snapshot_path_to_root_analysis", "workspace/heap-snapshot-path-to-root-analysis.json", "/workspace/browser/", "heap-snapshot-path-to-root-analysis.json", "audit", ("browser_runtime", "hook", "review")),
