...
- Full source-map consumer semantics beyond the current local remap, review-only bundler symbol scope descriptor, and review-gated credentialless URL fetch metadata baseline; current symbol scope output is a conservative review descriptor, not complete binding / lexical scope resolution.
