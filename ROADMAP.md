...
- Additional provider-specific compatibility / readiness rules when real third-party provider plugins introduce new capability flags, lifecycle policies, vendor account constraints, or smoke-evidence requirements beyond the built-in v4 required-metadata baseline.
