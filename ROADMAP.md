...
- Review `workspace-foldered-canonical-migration-preflight` after a ready `workspace-foldered-canonical-migration-pilot-plan` to confirm legacy / future candidate file existence, SHA-256 parity, and rollback requirements before any separate physical canonical-path migration executor; current support remains preflight-only and keeps flat paths authoritative.
