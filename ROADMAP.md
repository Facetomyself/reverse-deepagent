...
- Execution-style arbitrary custom loader traversal and deep async chunk traversal beyond the current review-only custom-loader traversal plan, review-gated webpack ensure baseline, and review-only async chunk module diff / hook candidate refresh baseline.
