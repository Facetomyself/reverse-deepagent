...
- Review-approved remote export hook installation, recursive federation traversal, and deeper remote-module analysis beyond the current reviewed factory invocation / export-summary plus review-only export-hook-plan baselines.
