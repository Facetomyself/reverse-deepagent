...
- Remote factory invocation / remote module body analysis beyond the current read-only runtime-path, review-only get/init plan, and review-gated init/get probe baselines.
