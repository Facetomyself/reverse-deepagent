...
- Remote export hook selection, recursive federation traversal, and deeper remote-module analysis beyond the current reviewed factory invocation / export-summary baseline.
