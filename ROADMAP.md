...
- Closure-scope function discovery baseline and review-only closure wrapper replacement planning baseline without automatic closure wrapper replacement.
...
- Opt-in reviewed wrapper replacement execution for closure-internal functions beyond the review-only `closure-wrapper-replacement-plan` baseline.
