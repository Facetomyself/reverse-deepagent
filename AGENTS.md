...
- 改 native collectors / hooks：检查 `tests/test_browser_collectors.py`、`tests/test_cdp_collectors.py`、`tests/test_browser_hooks.py`、`tests/test_breakpoint_manager.py`。
