...
- cross-process live CDP paused execution continuation，超过当前只读 live-continuation preflight、target attach readiness proof 和 cross-process execution plan baseline；真正 reviewed attach probe、live callFrame recovery、resume / step / evaluate executor 仍未实现。
